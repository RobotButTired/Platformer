...
HXLINE(  81)			 ::openfl::geom::Point _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  81)			_hx_tmp1->x = (_hx_tmp1->x * norm);
HXLINE(  82)			 ::openfl::geom::Point _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  82)			_hx_tmp2->y = (_hx_tmp2->y * norm);
            		}
            	}
