...
HXDLIN( 123)		if (::Std_obj::is(value,hx::ClassOf< ::hx::Class >())) {
...
HXDLIN( 126)			if (!(::Std_obj::is(value,hx::ClassOf< bool >()))) {
...
HXDLIN( 127)				if (!(::Std_obj::is(value,hx::ClassOf< int >()))) {
HXLINE( 127)					_hx_tmp1 = hx::IsEq( value,hx::ClassOf< int >() );
            				}
            				else {
...
HXDLIN( 128)					if (!(::Std_obj::is(value,hx::ClassOf< ::Float >()))) {
HXLINE( 128)						_hx_tmp2 = hx::IsEq( value,hx::ClassOf< ::Float >() );
            					}
            					else {
HXLINE( 128)						_hx_tmp2 = true;
            					}
...
HXDLIN( 139)		if (::Std_obj::is(value,hx::ClassOf< ::hx::Class >())) {
...
HXLINE( 253)				::cpp::VirtualArray v1;
HXDLIN( 253)				if (hx::IsNull( args )) {
HXLINE( 253)					v1 = ::cpp::VirtualArray_obj::__new(0);
            				}
            				else {
HXLINE( 253)					v1 = args;
            				}
HXDLIN( 253)				::Reflect_obj::callMethod(closure,closure,v1);
            			}
            			HX_END_LOCAL_FUNC0((void))
