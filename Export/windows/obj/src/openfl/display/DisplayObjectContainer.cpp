...
HXLINE(  67)			HX_STACK_DO_THROW(error);
            		}
            		else {
HXLINE(  70)			if (hx::IsEq( child->stage,child )) {
HXLINE(  72)				 ::openfl::errors::ArgumentError error1 =  ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("Error #3783: A Stage object cannot be added as the child of another object.",fa,51,93,42));
HXLINE(  73)				error1->errorID = 3783;
HXLINE(  74)				HX_STACK_DO_THROW(error1);
            			}
            		}
...
HXLINE(  80)			HX_STACK_DO_THROW((HX_("Invalid index position ",80,59,50,86) + index));
            		}
...
HXLINE( 216)					_hx_tmp1 = hx::IsEq( this->stage->get_focus(),child );
            				}
            				else {
...
HXLINE( 221)				 ::openfl::events::Event event1 =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removedFromStage",34,21,76,ba),false,false);
HXLINE( 222)				child->_hx___dispatchWithCapture(event1);
HXLINE( 223)				child->_hx___dispatchChildren(event1);
...
HXLINE( 264)				HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,HX_("The supplied index is out of bounds.",17,96,1b,51)));
            			}
            		}
...
HXLINE( 450)				_hx_tmp2 = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE( 451)			_hx_tmp3 = !(this->get_mask()->_hx___hitTestMask(x,y));
            		}
            		else {
...
HXLINE( 471)				_hx_tmp4 = !(this->mouseChildren);
            			}
            			else {
...
HXLINE( 497)						bool _hx_tmp5;
HXDLIN( 497)						if (!(interactive)) {
HXLINE( 497)							if (this->mouseEnabled) {
HXLINE( 497)								_hx_tmp5 = !(hitTest);
            							}
            							else {
HXLINE( 497)								_hx_tmp5 = false;
            							}
            						}
            						else {
HXLINE( 497)							_hx_tmp5 = true;
            						}
...
HXLINE( 503)									_hx_tmp6 = (stack->length > length);
            								}
            								else {
...
HXLINE( 520)			bool hitTest1 = false;
...
HXDLIN( 590)			::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN( 590)			while((_g2 < _g11->length)){
HXLINE( 590)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 590)				_g2 = (_g2 + 1);
HXLINE( 592)				child1->_hx___renderCairo(renderer);
            			}
            		}
...
HXDLIN( 642)			::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN( 642)			while((_g2 < _g11->length)){
HXLINE( 642)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 642)				_g2 = (_g2 + 1);
HXLINE( 644)				child1->_hx___renderCanvas(renderer);
            			}
            		}
...
HXLINE( 677)		{
HXLINE( 677)			{
HXLINE( 677)				 ::Dynamic orphan2 = this->_hx___removedChildren->iterator();
HXDLIN( 677)				while(( (bool)(orphan2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 677)					 ::openfl::display::DisplayObject orphan3 = ( ( ::openfl::display::DisplayObject)(orphan2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXDLIN( 677)					if (hx::IsNull( orphan3->stage )) {
HXLINE( 677)						orphan3->_hx___cleanup();
            					}
            				}
            			}
...
HXDLIN( 697)			::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN( 697)			while((_g2 < _g11->length)){
HXLINE( 697)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 697)				_g2 = (_g2 + 1);
HXLINE( 699)				child1->_hx___renderDOM(renderer);
            			}
            		}
...
HXLINE( 716)		{
HXLINE( 716)			{
HXLINE( 716)				 ::Dynamic orphan2 = this->_hx___removedChildren->iterator();
HXDLIN( 716)				while(( (bool)(orphan2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 716)					 ::openfl::display::DisplayObject orphan3 = ( ( ::openfl::display::DisplayObject)(orphan2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXDLIN( 716)					if (hx::IsNull( orphan3->stage )) {
HXLINE( 716)						orphan3->_hx___cleanup();
            					}
            				}
            			}
...
HXDLIN( 751)				::Array< ::Dynamic> _g11 = this->_hx___children;
HXDLIN( 751)				while((_g2 < _g11->length)){
HXLINE( 751)					 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 751)					_g2 = (_g2 + 1);
HXLINE( 753)					child1->_hx___renderGL(renderer);
            				}
            			}
            		}
