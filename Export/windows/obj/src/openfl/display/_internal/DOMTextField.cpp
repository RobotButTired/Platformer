...
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_25_clear,"openfl.display._internal.DOMTextField","clear",0x58a798c6,"openfl.display._internal.DOMTextField.clear","openfl/display/_internal/DOMTextField.hx",25,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_37_measureText,"openfl.display._internal.DOMTextField","measureText",0xa92bd324,"openfl.display._internal.DOMTextField.measureText","openfl/display/_internal/DOMTextField.hx",37,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_73_render,"openfl.display._internal.DOMTextField","render",0x377f95fd,"openfl.display._internal.DOMTextField.render","openfl/display/_internal/DOMTextField.hx",73,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_341___getAttributeMatch,"openfl.display._internal.DOMTextField","__getAttributeMatch",0x43d53498,"openfl.display._internal.DOMTextField.__getAttributeMatch","openfl/display/_internal/DOMTextField.hx",341,0xc7d4d214)
HX_LOCAL_STACK_FRAME(_hx_pos_737ece1df218ad42_16_boot,"openfl.display._internal.DOMTextField","boot",0xe1e5e719,"openfl.display._internal.DOMTextField.boot","openfl/display/_internal/DOMTextField.hx",16,0xc7d4d214)
...
void DOMTextField_obj::clear( ::openfl::text::TextField textField, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_25_clear)
            	}
...
void DOMTextField_obj::measureText( ::openfl::text::TextField textField){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_37_measureText)
            	}
...
void DOMTextField_obj::render( ::openfl::text::TextField textField, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_73_render)
            	}
...
::String DOMTextField_obj::_hx___getAttributeMatch( ::EReg regex){
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_341___getAttributeMatch)
HXDLIN( 341)		if (hx::IsNotNull( regex->matched(2) )) {
HXDLIN( 341)			return regex->matched(2);
            		}
            		else {
HXDLIN( 341)			return regex->matched(3);
            		}
...
{
{
            	HX_STACKFRAME(&_hx_pos_737ece1df218ad42_16_boot)
HXDLIN(  16)		__mClass->__meta__ =  ::Dynamic(hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("obj",f7,8f,54,00), ::Dynamic(hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("SuppressWarnings",0c,d3,d2,00),::cpp::VirtualArray_obj::__new(1)->init(0,HX_("checkstyle:FieldDocComment",70,56,1b,20))))));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_737ece1df218ad42_18_boot)
...
HXDLIN(  19)		_hx___regexFace =  ::EReg_obj::__alloc( HX_CTX ,HX_("face=(\"([^\"]+)\"|'([^']+)')",1e,00,2b,89),HX_("i",69,00,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_737ece1df218ad42_20_boot)
HXDLIN(  20)		_hx___regexFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("<font ([^>]+)>",eb,24,d0,0a),HX_("gi",22,5a,00,00));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_737ece1df218ad42_21_boot)
HXDLIN(  21)		_hx___regexCloseFont =  ::EReg_obj::__alloc( HX_CTX ,HX_("</font>",3c,82,5f,8e),HX_("gi",22,5a,00,00));
            	}
{
