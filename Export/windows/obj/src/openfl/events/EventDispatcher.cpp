...
HXLINE(  45)			::Array< ::Dynamic> list1 = ( (::Array< ::Dynamic>)(this->_hx___eventMap->get(type)) );
HXLINE(  47)			{
HXLINE(  47)				int _g = 0;
HXDLIN(  47)				int _g1 = list1->length;
HXDLIN(  47)				while((_g < _g1)){
HXLINE(  47)					_g = (_g + 1);
HXDLIN(  47)					int i = (_g - 1);
HXLINE(  49)					if (list1->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >()->match(listener,useCapture)) {
HXLINE(  49)						return;
            					}
            				}
            			}
...
HXLINE(  54)					 ::openfl::events::_EventDispatcher::DispatchIterator iterator1 = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
HXDLIN(  54)					_g2 = (_g2 + 1);
HXLINE(  56)					if (iterator1->active) {
HXLINE(  58)						iterator1->copy();
            					}
            				}
            			}
HXLINE(  62)			this->_hx___addListenerByPriority(list1, ::openfl::events::_EventDispatcher::Listener_obj::__alloc( HX_CTX ,listener,useCapture,priority));
            		}
            	}
...
HXDLIN( 100)						while((_g2 < iterators->length)){
HXLINE( 100)							 ::openfl::events::_EventDispatcher::DispatchIterator iterator = iterators->__get(_g2).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
