...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_cowboy_cowboy4_jumo_with_gun_0_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:image("Assets/Cowboy/Cowboy4_jumo with gun_0.png") @:noCompletion #if display private #end class __ASSET__assets_cowboy_cowboy4_jumo_with_gun_0_png extends lime.graphics.Image {}
