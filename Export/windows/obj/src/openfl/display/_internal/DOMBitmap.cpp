...
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_39_render,"openfl.display._internal.DOMBitmap","render",0xad06f50f,"openfl.display._internal.DOMBitmap.render","openfl/display/_internal/DOMBitmap.hx",39,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_65_renderCanvas,"openfl.display._internal.DOMBitmap","renderCanvas",0x9cc57347,"openfl.display._internal.DOMBitmap.renderCanvas","openfl/display/_internal/DOMBitmap.hx",65,0xcb448c4c)
HX_LOCAL_STACK_FRAME(_hx_pos_d34f8755a1b4262c_107_renderImage,"openfl.display._internal.DOMBitmap","renderImage",0x1c91e3cc,"openfl.display._internal.DOMBitmap.renderImage","openfl/display/_internal/DOMBitmap.hx",107,0xcb448c4c)
...
void DOMBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_39_render)
            	}
...
void DOMBitmap_obj::renderCanvas( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_65_renderCanvas)
            	}
...
void DOMBitmap_obj::renderImage( ::openfl::display::Bitmap bitmap, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_d34f8755a1b4262c_107_renderImage)
            	}
