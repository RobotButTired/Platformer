...
HXLINE( 942)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
...
HXLINE( 944)						_hx_tmp4 = (x <= (group1->offsetX + group1->width));
            					}
            					else {
...
HXDLIN( 948)							int _g4 = group1->positions->length;
HXDLIN( 948)							while((_g3 < _g4)){
HXLINE( 948)								_g3 = (_g3 + 1);
HXDLIN( 948)								int i1 = (_g3 - 1);
HXLINE( 950)								Float advance1;
HXDLIN( 950)								bool advance2;
HXDLIN( 950)								if ((i1 >= 0)) {
HXLINE( 950)									advance2 = (i1 < group1->positions->length);
            								}
            								else {
HXLINE( 950)									advance2 = false;
            								}
HXDLIN( 950)								if (advance2) {
HXLINE( 950)									advance1 = group1->positions->__get(i1).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            								}
            								else {
...
HXLINE( 954)									return (group1->startIndex + i1);
            								}
            							}
            						}
...
HXLINE(1045)				bool _hx_tmp3;
HXDLIN(1045)				if ((y >= group1->offsetY)) {
HXLINE(1045)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
HXLINE(1045)					_hx_tmp3 = false;
            				}
HXDLIN(1045)				if (_hx_tmp3) {
...
HXLINE(1072)					_hx_tmp1 = (group1->endIndex >= charIndex);
            				}
            				else {
...
HXLINE(1261)			HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,HX_("The supplied index is out of bounds",37,5a,d3,87)));
            		}
...
HXLINE(1270)				bool _hx_tmp3;
HXDLIN(1270)				bool _hx_tmp4;
HXDLIN(1270)				if ((group1->start <= beginIndex)) {
HXLINE(1270)					_hx_tmp4 = (group1->end > beginIndex);
            				}
            				else {
...
HXLINE(1270)						_hx_tmp3 = (group1->end >= endIndex);
            					}
            					else {
HXLINE(1270)						_hx_tmp3 = false;
            					}
            				}
            				else {
...
HXLINE(1486)					_hx_tmp1 = (range->end == endIndex);
            				}
            				else {
...
HXLINE(1492)					bool _hx_tmp2;
HXDLIN(1492)					if ((range->start >= beginIndex)) {
HXLINE(1492)						_hx_tmp2 = (range->end <= endIndex);
            					}
            					else {
...
HXDLIN(1497)						bool _hx_tmp4;
HXDLIN(1497)						if ((range->start >= beginIndex)) {
HXLINE(1497)							_hx_tmp4 = (range->start < endIndex);
            						}
            						else {
HXLINE(1497)							_hx_tmp4 = false;
            						}
HXDLIN(1497)						if (_hx_tmp4) {
HXLINE(1497)							_hx_tmp3 = (range->end > beginIndex);
            						}
            						else {
...
HXLINE(1506)							bool _hx_tmp5;
HXDLIN(1506)							bool _hx_tmp6;
HXDLIN(1506)							if ((range->start < beginIndex)) {
HXLINE(1506)								_hx_tmp6 = (range->end > beginIndex);
            							}
            							else {
HXLINE(1506)								_hx_tmp6 = false;
            							}
HXDLIN(1506)							if (_hx_tmp6) {
HXLINE(1506)								_hx_tmp5 = (range->end >= endIndex);
            							}
            							else {
HXLINE(1506)								_hx_tmp5 = false;
            							}
HXDLIN(1506)							if (_hx_tmp5) {
HXLINE(1509)								 ::openfl::text::TextFormat newRange2 = range->format->clone();
HXDLIN(1509)								newRange =  ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,newRange2,beginIndex,range->end);
...
HXLINE(1652)					_hx_tmp1 = (url != HX_("",00,00,00,00));
            				}
            				else {
...
HXLINE(1727)				bool _hx_tmp1;
HXDLIN(1727)				if ((charIndex >= group1->startIndex)) {
HXLINE(1727)					_hx_tmp1 = (charIndex < group1->endIndex);
            				}
            				else {
HXLINE(1727)					_hx_tmp1 = false;
            				}
HXDLIN(1727)				if (_hx_tmp1) {
HXLINE(1729)					try {
            						HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(1731)						Float x = group1->offsetX;
HXLINE(1733)						{
HXLINE(1733)							int _g1 = 0;
HXDLIN(1733)							int _g2 = (charIndex - group1->startIndex);
HXDLIN(1733)							while((_g1 < _g2)){
HXLINE(1733)								_g1 = (_g1 + 1);
HXDLIN(1733)								int i = (_g1 - 1);
...
HXLINE(1760)					_hx_tmp2 = (charIndex <= group1->endIndex);
            				}
            				else {
...
HXLINE(1764)					{
HXLINE(1764)						int _g1 = 0;
HXDLIN(1764)						int _g2 = (charIndex - group1->startIndex);
HXDLIN(1764)						while((_g1 < _g2)){
HXLINE(1764)							_g1 = (_g1 + 1);
HXDLIN(1764)							int i = (_g1 - 1);
...
HXLINE(1776)					{
HXLINE(1776)						int _g11 = 0;
HXDLIN(1776)						int _g21 = (this->get_scrollV() - 1);
HXDLIN(1776)						while((_g11 < _g21)){
HXLINE(1776)							_g11 = (_g11 + 1);
HXDLIN(1776)							int i1 = (_g11 - 1);
HXLINE(1778)							y = (y - this->_hx___textEngine->lineHeights->get(i1));
            						}
            					}
...
HXDLIN(1820)				int i1 = (_g2 - 1);
HXLINE(1822)				group = this->_hx___textEngine->layoutGroups->get(i1).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
HXLINE(1824)				if ((i1 < (this->_hx___textEngine->layoutGroups->get_length() - 1))) {
HXLINE(1826)					nextGroup = this->_hx___textEngine->layoutGroups->get((i1 + 1)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
            				}
            				else {
...
HXDLIN(1840)				bool _hx_tmp2;
HXDLIN(1840)				if ((y >= group->offsetY)) {
HXLINE(1840)					_hx_tmp2 = (y <= (group->offsetY + group->height));
            				}
            				else {
...
HXLINE(1840)						_hx_tmp1 = hx::IsNull( nextGroup );
            					}
            					else {
...
HXLINE(1842)					bool _hx_tmp3;
HXDLIN(1842)					bool _hx_tmp4;
HXDLIN(1842)					if ((x >= group->offsetX)) {
HXLINE(1842)						_hx_tmp4 = (x <= (group->offsetX + group->width));
            					}
            					else {
HXLINE(1842)						_hx_tmp4 = false;
            					}
HXDLIN(1842)					if (!(_hx_tmp4)) {
HXLINE(1843)						if (!(precise)) {
HXLINE(1843)							if (hx::IsNotNull( nextGroup )) {
HXLINE(1842)								_hx_tmp3 = (nextGroup->lineIndex != group->lineIndex);
            							}
            							else {
HXLINE(1842)								_hx_tmp3 = true;
            							}
            						}
            						else {
HXLINE(1842)							_hx_tmp3 = false;
            						}
            					}
            					else {
HXLINE(1842)						_hx_tmp3 = true;
            					}
HXDLIN(1842)					if (_hx_tmp3) {
...
HXDLIN(1932)				bool _hx_tmp2;
HXDLIN(1932)				if ((alpha > 0)) {
HXLINE(1932)					_hx_tmp2 = hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE(1932)					_hx_tmp2 = false;
            				}
HXDLIN(1932)				if (_hx_tmp2) {
HXLINE(1932)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN(1932)						int _hx_tmp3;
HXDLIN(1932)						bool _hx_tmp4;
HXDLIN(1932)						if (renderer->_hx___allowSmoothing) {
HXLINE(1932)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXLINE(1932)							_hx_tmp4 = false;
            						}
HXDLIN(1932)						if (_hx_tmp4) {
HXLINE(1932)							_hx_tmp3 = 1;
            						}
            						else {
HXLINE(1932)							_hx_tmp3 = 3;
            						}
HXDLIN(1932)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);
...
HXLINE(2056)				_hx_tmp1 = hx::IsNull( this->_hx___graphics );
            			}
            			else {
HXLINE(2056)				_hx_tmp1 = false;
            			}
HXDLIN(2056)			if (!(_hx_tmp1)) {
HXLINE(2056)				bool _hx_tmp2;
HXDLIN(2056)				if (!(!(this->_hx___renderable))) {
HXLINE(2056)					_hx_tmp2 = (this->_hx___worldAlpha <= 0);
            				}
            				else {
HXLINE(2056)					_hx_tmp2 = true;
            				}
HXDLIN(2056)				if (!(_hx_tmp2)) {
HXLINE(2056)					bool _hx_tmp3;
HXDLIN(2056)					bool _hx_tmp4;
HXDLIN(2056)					bool _hx_tmp5;
HXDLIN(2056)					if (hx::IsNotNull( this->opaqueBackground )) {
HXLINE(2056)						_hx_tmp5 = !(this->_hx___isCacheBitmapRender);
            					}
            					else {
HXLINE(2056)						_hx_tmp5 = false;
            					}
HXDLIN(2056)					if (_hx_tmp5) {
HXLINE(2056)						_hx_tmp4 = (this->get_width() > 0);
            					}
            					else {
HXLINE(2056)						_hx_tmp4 = false;
            					}
HXDLIN(2056)					if (_hx_tmp4) {
HXLINE(2056)						_hx_tmp3 = (this->get_height() > 0);
            					}
            					else {
HXLINE(2056)						_hx_tmp3 = false;
            					}
HXDLIN(2056)					if (_hx_tmp3) {
...
HXDLIN(2056)						Float _hx_tmp6 = this->get_width();
HXDLIN(2056)						rect->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp6,this->get_height());
...
HXLINE(2135)			bool _hx_tmp4;
HXDLIN(2135)			if ((range->start <= beginIndex)) {
HXLINE(2135)				_hx_tmp4 = (range->end >= endIndex);
            			}
            			else {
HXLINE(2135)				_hx_tmp4 = false;
            			}
HXDLIN(2135)			if (_hx_tmp4) {
HXLINE(2137)				 ::openfl::text::_internal::TextFormatRange range1 = range;
HXDLIN(2137)				range1->end = (range1->end + offset);
HXLINE(2138)				i = (i + 1);
            			}
            			else {
HXLINE(2140)				bool _hx_tmp5;
HXDLIN(2140)				if ((range->start >= beginIndex)) {
HXLINE(2140)					_hx_tmp5 = (range->end <= endIndex);
            				}
            				else {
...
HXLINE(2155)					bool _hx_tmp6;
HXDLIN(2155)					if ((range->start > beginIndex)) {
HXLINE(2155)						_hx_tmp6 = (range->start <= endIndex);
            					}
            					else {
HXLINE(2155)						_hx_tmp6 = false;
            					}
HXDLIN(2155)					if (_hx_tmp6) {
HXLINE(2157)						 ::openfl::text::_internal::TextFormatRange range2 = range;
HXDLIN(2157)						range2->start = (range2->start + offset);
HXLINE(2158)						i = (i + 1);
            					}
            					else {
HXLINE(2162)						i = (i + 1);
...
HXLINE(2239)				 ::openfl::geom::Matrix _hx_tmp4 = this->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN(2239)				_hx_tmp4->tx = (_hx_tmp4->tx - this->_hx___offsetX);
HXLINE(2240)				 ::openfl::geom::Matrix _hx_tmp5 = this->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN(2240)				_hx_tmp5->ty = (_hx_tmp5->ty - this->_hx___offsetY);
            			}
...
HXDLIN(2267)						goto _hx_goto_73;
            					...
            					if (  (_hx_switch_0==3) ){
HXLINE(2264)						 ::openfl::text::TextField _g1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(2264)						Float _hx_tmp1 = _g1->get_x();
HXDLIN(2264)						_g1->set_x((_hx_tmp1 + (cacheWidth - this->_hx___textEngine->width)));
...
HXLINE(2294)				int _hx_tmp1 = this->_hx___caretIndex;
HXDLIN(2294)				if ((_hx_tmp1 >= this->get_text().length)) {
...
HXLINE(2307)						Float caret2 = caret->x;
HXDLIN(2307)						int _hx_tmp2 = this->get_scrollH();
HXDLIN(2307)						if ((caret2 > (_hx_tmp2 + this->_hx___textEngine->width))) {
...
HXLINE(2345)					Float _hx_tmp1 = (tempHeight + this->_hx___textEngine->lineHeights->get(i));
HXDLIN(2345)					if ((_hx_tmp1 <= (this->get_height() - ( (Float)(4) )))) {
...
HXLINE(2815)				_hx_tmp1 = hx::IsEq( this->stage->get_focus(),hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(3116)			_hx_tmp = !(::Std_obj::is(event->relatedObject,hx::ClassOf< ::openfl::text::TextField >()));
            		}
            		else {
...
HXLINE(3202)						bool _hx_tmp2;
HXDLIN(3202)						if ((pos < rightPos)) {
HXLINE(3202)							_hx_tmp2 = (pos != -1);
            						}
            						else {
...
HXLINE(3429)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            			...
            			break;
            			case (int)127: {
HXLINE(3265)				bool _hx_tmp1;
HXDLIN(3265)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3265)					_hx_tmp1 = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3265)					_hx_tmp1 = false;
            				}
HXDLIN(3265)				if (_hx_tmp1) {
...
HXLINE(3387)							int lineIndex1 = this->getLineIndexOfChar(::Std_obj::_hx_int(::Math_obj::min(( (Float)(this->_hx___caretIndex) ),( (Float)(this->_hx___selectionIndex) ))));
HXLINE(3388)							this->_hx___caretPreviousLine(lineIndex1,::Std_obj::_hx_int(::Math_obj::min(( (Float)(this->_hx___caretIndex) ),( (Float)(this->_hx___selectionIndex) ))));
            						}
...
HXLINE(3238)					 ::openfl::events::TextEvent te1 =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
HXLINE(3240)					this->dispatchEvent(te1);
HXLINE(3242)					if (!(te1->isDefaultPrevented())) {
