...
HXLINE( 156)				_hx_tmp10 = (this->greenMultiplier == 1);
            			}
            			else {
HXLINE( 156)				_hx_tmp10 = false;
            			}
HXDLIN( 156)			if (_hx_tmp10) {
HXLINE( 156)				_hx_tmp9 = (this->blueMultiplier == 1);
            			}
            			else {
HXLINE( 156)				_hx_tmp9 = false;
            			}
HXDLIN( 156)			if (_hx_tmp9) {
HXLINE( 156)				_hx_tmp8 = (this->alphaMultiplier == 1);
            			}
            			else {
HXLINE( 156)				_hx_tmp8 = false;
            			}
HXDLIN( 156)			if (_hx_tmp8) {
HXLINE( 156)				_hx_tmp7 = (this->redOffset == 0);
            			}
            			else {
HXLINE( 156)				_hx_tmp7 = false;
            			}
HXDLIN( 156)			if (_hx_tmp7) {
HXLINE( 156)				_hx_tmp6 = (this->greenOffset == 0);
            			}
            			else {
HXLINE( 156)				_hx_tmp6 = false;
            			}
HXDLIN( 156)			if (_hx_tmp6) {
HXLINE( 156)				_hx_tmp5 = (this->blueOffset == 0);
            			}
            			else {
...
HXLINE( 200)		{
HXLINE( 200)			 ::lime::utils::ArrayBufferView this2 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 200)			Float val = this->redMultiplier;
HXDLIN( 200)			 ::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            		}
HXLINE( 201)		{
HXLINE( 201)			 ::lime::utils::ArrayBufferView this3 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 201)			Float val1 = (this->redOffset / ( (Float)(255) ));
HXDLIN( 201)			 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 16),val1);
            		}
HXLINE( 202)		{
HXLINE( 202)			 ::lime::utils::ArrayBufferView this4 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 202)			Float val2 = this->greenMultiplier;
HXDLIN( 202)			 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 24),val2);
            		}
HXLINE( 203)		{
HXLINE( 203)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 203)			Float val3 = (this->greenOffset / ( (Float)(255) ));
HXDLIN( 203)			 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 36),val3);
            		}
HXLINE( 204)		{
HXLINE( 204)			 ::lime::utils::ArrayBufferView this6 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 204)			Float val4 = this->blueMultiplier;
HXDLIN( 204)			 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 48),val4);
            		}
HXLINE( 205)		{
HXLINE( 205)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 205)			Float val5 = (this->blueOffset / ( (Float)(255) ));
HXDLIN( 205)			 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 56),val5);
            		}
HXLINE( 206)		{
HXLINE( 206)			 ::lime::utils::ArrayBufferView this8 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 206)			Float val6 = this->alphaMultiplier;
HXDLIN( 206)			 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 72),val6);
            		}
HXLINE( 207)		{
HXLINE( 207)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 207)			Float val7 = (this->alphaOffset / ( (Float)(255) ));
HXDLIN( 207)			 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + 76),val7);
            		}
