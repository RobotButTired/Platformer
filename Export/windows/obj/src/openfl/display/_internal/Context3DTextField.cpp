...
HX_LOCAL_STACK_FRAME(_hx_pos_fad01968ffdb63cd_28_renderMask,"openfl.display._internal.Context3DTextField","renderMask",0xe51b1967,"openfl.display._internal.Context3DTextField.renderMask","openfl/display/_internal/Context3DTextField.hx",28,0xdb755bb2)
...
void Context3DTextField_obj::renderMask( ::openfl::text::TextField textField, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_fad01968ffdb63cd_28_renderMask)
HXLINE(  32)		::openfl::display::_internal::CairoTextField_obj::render(textField,( ( ::openfl::display::CairoRenderer)(renderer->_hx___softwareRenderer) ),textField->_hx___worldTransform);
