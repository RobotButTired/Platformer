...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("14",e3,2a,00,00));
...
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.platformer",37,d0,b5,1c));
