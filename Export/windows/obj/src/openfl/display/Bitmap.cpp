...
HXLINE( 101)				_hx_tmp6 = !(this->_hx___scrollRect->contains(px,py));
            			}
            			else {
...
HXLINE( 106)			bool _hx_tmp7;
HXDLIN( 106)			if (hx::IsNotNull( stack )) {
HXLINE( 106)				_hx_tmp7 = !(interactiveOnly);
            			}
            			else {
HXLINE( 106)				_hx_tmp7 = false;
            			}
...
HXLINE( 146)					_hx_tmp3 = hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE( 146)					_hx_tmp3 = false;
            				}
HXDLIN( 146)				if (_hx_tmp3) {
HXLINE( 146)					_hx_tmp2 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN( 146)						int _hx_tmp4;
HXDLIN( 146)						bool _hx_tmp5;
HXDLIN( 146)						if (renderer->_hx___allowSmoothing) {
HXLINE( 146)							_hx_tmp5 = bitmap->smoothing;
            						}
            						else {
HXLINE( 146)							_hx_tmp5 = false;
            						}
HXDLIN( 146)						if (_hx_tmp5) {
HXLINE( 146)							_hx_tmp4 = 1;
            						}
            						else {
HXLINE( 146)							_hx_tmp4 = 3;
            						}
HXDLIN( 146)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp4);
...
HXLINE( 151)				Float alpha1 = renderer->_hx___getAlpha(this->_hx___worldAlpha);
HXDLIN( 151)				bool _hx_tmp6;
HXDLIN( 151)				bool _hx_tmp7;
HXDLIN( 151)				if ((alpha1 > 0)) {
HXLINE( 151)					_hx_tmp7 = hx::IsNotNull( this->_hx___bitmapData );
            				}
            				else {
HXLINE( 151)					_hx_tmp7 = false;
            				}
HXDLIN( 151)				if (_hx_tmp7) {
HXLINE( 151)					_hx_tmp6 = this->_hx___bitmapData->_hx___isValid;
            				}
            				else {
HXLINE( 151)					_hx_tmp6 = false;
            				}
HXDLIN( 151)				if (_hx_tmp6) {
HXLINE( 151)					 ::lime::graphics::cairo::Cairo cairo1 = renderer->cairo;
...
HXDLIN( 151)					renderer->applyMatrix(this->_hx___renderTransform,cairo1);
HXDLIN( 151)					 ::Dynamic surface1 = this->_hx___bitmapData->getSurface();
HXDLIN( 151)					if (hx::IsNotNull( surface1 )) {
HXLINE( 151)						 ::Dynamic pattern1 = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface1);
HXDLIN( 151)						int _hx_tmp8;
HXDLIN( 151)						bool _hx_tmp9;
HXDLIN( 151)						if (renderer->_hx___allowSmoothing) {
HXLINE( 151)							_hx_tmp9 = this->smoothing;
            						}
            						else {
HXLINE( 151)							_hx_tmp9 = false;
            						}
HXDLIN( 151)						if (_hx_tmp9) {
HXLINE( 151)							_hx_tmp8 = 1;
            						}
            						else {
HXLINE( 151)							_hx_tmp8 = 3;
            						}
HXDLIN( 151)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern1,_hx_tmp8);
HXDLIN( 151)						cairo1->set_source(pattern1);
HXDLIN( 151)						if ((alpha1 == 1)) {
HXLINE( 151)							cairo1->paint();
            						}
            						else {
HXLINE( 151)							cairo1->paintWithAlpha(alpha1);
            						}
            					}
...
HXLINE( 230)				_hx_tmp2 = hx::IsNull( this->_hx___graphics );
            			}
            			else {
...
HXLINE( 230)					_hx_tmp3 = (this->_hx___worldAlpha <= 0);
            				}
            				else {
...
HXLINE( 230)						_hx_tmp6 = !(this->_hx___isCacheBitmapRender);
            					}
            					else {
HXLINE( 230)						_hx_tmp6 = false;
            					}
HXDLIN( 230)					if (_hx_tmp6) {
HXLINE( 230)						_hx_tmp5 = (this->get_width() > 0);
            					}
            					else {
HXLINE( 230)						_hx_tmp5 = false;
            					}
HXDLIN( 230)					if (_hx_tmp5) {
HXLINE( 230)						_hx_tmp4 = (this->get_height() > 0);
            					}
            					else {
...
HXDLIN( 230)						Float _hx_tmp7 = this->get_width();
HXDLIN( 230)						rect->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp7,this->get_height());
...
HXLINE( 248)			_hx_tmp2 = (this->_hx___bitmapData->image->version != this->_hx___imageVersion);
            		}
            		else {
HXLINE( 248)			_hx_tmp2 = false;
            		}
HXDLIN( 248)		return this->super::_hx___updateCacheBitmap(renderer,_hx_tmp2);
            	}
