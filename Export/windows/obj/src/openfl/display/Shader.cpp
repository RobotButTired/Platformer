...
HXLINE( 275)				 ::openfl::display::ShaderParameter_Float parameter1 = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 275)				_g2 = (_g2 + 1);
HXLINE( 277)				parameter1->_hx___useArray = false;
            			}
            		}
HXLINE( 280)		{
...
HXLINE( 280)				 ::openfl::display::ShaderParameter_Int parameter2 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 280)				_g4 = (_g4 + 1);
HXLINE( 282)				parameter2->_hx___useArray = false;
            			}
            		}
            	}
...
HXLINE( 393)				 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 393)				_g4 = (_g4 + 1);
HXLINE( 395)				parameter1->_hx___disableGL(this->_hx___context);
            			}
            		}
HXLINE( 398)		{
...
HXLINE( 398)				 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 398)				_g6 = (_g6 + 1);
HXLINE( 400)				parameter2->_hx___disableGL(this->_hx___context);
            			}
            		}
...
HXLINE( 536)						 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 536)						_g4 = (_g4 + 1);
HXLINE( 538)						if (parameter1->_hx___isUniform) {
HXLINE( 540)							parameter1->index = gl->getUniformLocation(this->glProgram,parameter1->name);
            						}
            						else {
HXLINE( 544)							parameter1->index = gl->getAttribLocation(this->glProgram,parameter1->name);
            						}
            					}
            				}
HXLINE( 548)				{
...
HXLINE( 548)						 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 548)						_g6 = (_g6 + 1);
HXLINE( 550)						if (parameter2->_hx___isUniform) {
HXLINE( 552)							parameter2->index = gl->getUniformLocation(this->glProgram,parameter2->name);
            						}
            						else {
HXLINE( 556)							parameter2->index = gl->getAttribLocation(this->glProgram,parameter2->name);
            						}
            					}
            				}
            			}
...
HXLINE( 674)						 ::openfl::display::ShaderParameter_Int parameter1 =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
HXLINE( 675)						parameter1->set_name(name);
HXLINE( 676)						parameter1->type = parameterType;
HXLINE( 677)						parameter1->_hx___arrayLength = arrayLength;
HXLINE( 678)						parameter1->_hx___isInt = true;
HXLINE( 679)						parameter1->_hx___isUniform = isUniform;
HXLINE( 680)						parameter1->__length = length;
HXLINE( 681)						this->_hx___paramInt->push(parameter1);
HXLINE( 682)						::Reflect_obj::setField(this->_hx___data,name,parameter1);
HXLINE( 683)						if (this->_hx___isGenerated) {
HXLINE( 683)							::Reflect_obj::setField(hx::ObjectPtr<OBJ_>(this),name,parameter1);
            						}
HXLINE( 673)						goto _hx_goto_29;
            					}
            					/* default */{
HXLINE( 686)						 ::openfl::display::ShaderParameter_Float parameter2 =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
HXLINE( 687)						parameter2->set_name(name);
HXLINE( 688)						parameter2->type = parameterType;
HXLINE( 689)						parameter2->_hx___arrayLength = arrayLength;
...
HXLINE( 691)										 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 691)										::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 691)										_this1->byteOffset = 0;
HXDLIN( 691)										_this1->length = array1->get_length();
HXDLIN( 691)										_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 691)										 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 691)										_this1->buffer = this3;
HXDLIN( 691)										_this1->copyFromArray(array1,null());
HXDLIN( 691)										this1 = _this1;
            									}
            									else {
HXLINE( 691)										if (hx::IsNotNull( view )) {
HXLINE( 691)											 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 691)											int elementSize = _this2->bytesPerElement;
HXDLIN( 691)											if ((view->type == _this2->type)) {
HXLINE( 691)												int srcLength1 = srcData->length;
HXDLIN( 691)												int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 691)												 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 691)												_this2->buffer = this4;
HXDLIN( 691)												_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            											}
            											else {
HXLINE( 691)												HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            											}
HXDLIN( 691)											_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 691)											_this2->byteOffset = 0;
HXDLIN( 691)											_this2->length = srcLength;
HXDLIN( 691)											this1 = _this2;
            										}
            										else {
HXLINE( 691)											if (hx::IsNotNull( buffer )) {
HXLINE( 691)												 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 691)												int in_byteOffset = 0;
HXDLIN( 691)												if ((in_byteOffset < 0)) {
HXLINE( 691)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 691)												if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 691)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 691)												int bufferByteLength = buffer->length;
HXDLIN( 691)												int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 691)													if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 691)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
...
HXLINE( 691)													newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 691)													int newRange = (in_byteOffset + newByteLength);
HXDLIN( 691)													if ((newRange > bufferByteLength)) {
HXLINE( 691)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
            												}
HXDLIN( 691)												_this3->buffer = buffer;
HXDLIN( 691)												_this3->byteOffset = in_byteOffset;
HXDLIN( 691)												_this3->byteLength = newByteLength;
HXDLIN( 691)												_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 691)												this1 = _this3;
            											}
            											else {
HXLINE( 691)												HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            											}
            										}
            									}
            								}
            							}
HXDLIN( 691)							parameter2->_hx___uniformMatrix = this1;
            						}
HXLINE( 693)						parameter2->_hx___isFloat = true;
HXLINE( 694)						parameter2->_hx___isUniform = isUniform;
HXLINE( 695)						parameter2->__length = length;
HXLINE( 696)						this->_hx___paramFloat->push(parameter2);
...
HXLINE( 713)						::Reflect_obj::setField(this->_hx___data,name,parameter2);
HXLINE( 714)						if (this->_hx___isGenerated) {
HXLINE( 714)							::Reflect_obj::setField(hx::ObjectPtr<OBJ_>(this),name,parameter2);
            						}
            					}
            					_hx_goto_29:;
            				}
...
HXLINE( 754)				 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 754)				_g4 = (_g4 + 1);
HXLINE( 756)				parameter1->_hx___updateGL(this->_hx___context,null());
            			}
            		}
HXLINE( 759)		{
...
HXLINE( 759)				 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 759)				_g6 = (_g6 + 1);
HXLINE( 761)				parameter2->_hx___updateGL(this->_hx___context,null());
            			}
            		}
            	}
...
HXLINE( 823)				if ((i1 < boolCount)) {
HXLINE( 825)					boolRef = shaderBuffer->paramRefs_Bool->__get(boolIndex).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXLINE( 827)					{
HXLINE( 827)						int _g21 = 0;
HXDLIN( 827)						int _g31 = shaderBuffer->overrideBoolCount;
HXDLIN( 827)						while((_g21 < _g31)){
HXLINE( 827)							_g21 = (_g21 + 1);
HXDLIN( 827)							int j = (_g21 - 1);
...
HXLINE( 843)						boolRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            					}
HXLINE( 846)					boolIndex = (boolIndex + 1);
            				}
            				else {
HXLINE( 848)					if ((i1 < (boolCount + floatCount))) {
HXLINE( 850)						floatRef = shaderBuffer->paramRefs_Float->__get(floatIndex).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXLINE( 852)						{
HXLINE( 852)							int _g22 = 0;
HXDLIN( 852)							int _g32 = shaderBuffer->overrideFloatCount;
HXDLIN( 852)							while((_g22 < _g32)){
HXLINE( 852)								_g22 = (_g22 + 1);
HXDLIN( 852)								int j1 = (_g22 - 1);
HXLINE( 854)								if ((floatRef->name == shaderBuffer->overrideFloatNames->__get(j1))) {
HXLINE( 856)									overrideFloatValue = shaderBuffer->overrideFloatValues->__get(j1).StaticCast< ::Array< Float > >();
...
HXLINE( 868)							floatRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            						}
...
HXLINE( 877)						{
HXLINE( 877)							int _g23 = 0;
HXDLIN( 877)							int _g33 = shaderBuffer->overrideIntCount;
HXDLIN( 877)							while((_g23 < _g33)){
HXLINE( 877)								_g23 = (_g23 + 1);
HXDLIN( 877)								int j2 = (_g23 - 1);
HXLINE( 879)								if ((intRef->name == shaderBuffer->overrideIntNames->__get(j2))) {
HXLINE( 881)									overrideIntValue = ::cpp::VirtualArray( shaderBuffer->overrideIntValues->__get(j2));
...
HXLINE( 893)							intRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            						}
