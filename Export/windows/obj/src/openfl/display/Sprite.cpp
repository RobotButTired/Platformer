...
HXLINE( 103)				_hx_tmp5 = hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 103)				_hx_tmp5 = false;
            			}
HXDLIN( 103)			if (_hx_tmp5) {
HXLINE( 103)				 ::openfl::display::Graphics _hx_tmp6 = this->_hx___graphics;
HXDLIN( 103)				_hx_tmp4 = _hx_tmp6->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
HXLINE( 103)				_hx_tmp4 = false;
            			}
HXDLIN( 103)			if (_hx_tmp4) {
HXLINE( 105)				bool _hx_tmp7;
HXDLIN( 105)				if (hx::IsNotNull( stack )) {
HXLINE( 105)					if (!(!(interactiveOnly))) {
HXLINE( 105)						_hx_tmp7 = this->mouseEnabled;
            					}
            					else {
HXLINE( 105)						_hx_tmp7 = true;
            					}
            				}
            				else {
HXLINE( 105)					_hx_tmp7 = false;
            				}
