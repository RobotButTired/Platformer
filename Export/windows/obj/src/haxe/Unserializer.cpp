...
HX_LOCAL_STACK_FRAME(_hx_pos_f8f88660db87045d_462_run,"haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",462,0x00b9ec83)
...
HXLINE( 232)		switch((int)(this->buf.cca(this->pos++))){
            			case (int)65: {
HXLINE( 437)				::String name = ( (::String)(this->unserialize()) );
HXLINE( 438)				hx::Class cl = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),hx::paccDynamic)(name);
HXLINE( 439)				if (hx::IsNull( cl )) {
HXLINE( 440)					HX_STACK_DO_THROW((HX_("Class not found ",13,56,74,ed) + name));
            				}
HXLINE( 441)				return cl;
            			}
            			break;
            			case (int)66: {
HXLINE( 443)				::String name1 = ( (::String)(this->unserialize()) );
HXLINE( 444)				hx::Class e = this->resolver->__Field(HX_("resolveEnum",0d,90,51,de),hx::paccDynamic)(name1);
HXLINE( 445)				if (hx::IsNull( e )) {
HXLINE( 446)					HX_STACK_DO_THROW((HX_("Enum not found ",aa,e1,55,fd) + name1));
            				}
HXLINE( 447)				return e;
            			}
            			break;
            			case (int)67: {
HXLINE( 426)				::String name2 = ( (::String)(this->unserialize()) );
HXLINE( 427)				hx::Class cl1 = this->resolver->__Field(HX_("resolveClass",ac,bd,dd,80),hx::paccDynamic)(name2);
HXLINE( 428)				if (hx::IsNull( cl1 )) {
HXLINE( 429)					HX_STACK_DO_THROW((HX_("Class not found ",13,56,74,ed) + name2));
            				}
HXLINE( 430)				 ::Dynamic o = ::Type_obj::createEmptyInstance(cl1);
HXLINE( 431)				this->cache->push(o);
HXLINE( 432)				o->__Field(HX_("hxUnserialize",37,db,b9,86),hx::paccDynamic)(hx::ObjectPtr<OBJ_>(this));
HXLINE( 433)				if ((this->buf.cca(this->pos++) != 103)) {
HXLINE( 434)					HX_STACK_DO_THROW(HX_("Invalid custom data",30,fa,ef,08));
            				}
HXLINE( 435)				return o;
            			}
            			break;
...
HXLINE( 392)				::Array< int > codes = ::haxe::Unserializer_obj::CODES;
HXLINE( 393)				if (hx::IsNull( codes )) {
HXLINE( 394)					codes = ::haxe::Unserializer_obj::initCodes();
HXLINE( 395)					::haxe::Unserializer_obj::CODES = codes;
            				}
HXLINE( 397)				int i1 = this->pos;
HXLINE( 398)				int rest = (len & 3);
HXLINE( 399)				int size;
HXDLIN( 399)				if ((rest >= 2)) {
HXLINE( 399)					size = (rest - 1);
            				}
            				else {
HXLINE( 399)					size = 0;
            				}
HXDLIN( 399)				int size1 = (((len >> 2) * 3) + size);
HXLINE( 400)				int max = (i1 + (len - rest));
HXLINE( 401)				 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(size1);
HXLINE( 402)				int bpos = 0;
HXLINE( 403)				while((i1 < max)){
HXLINE( 404)					i1 = (i1 + 1);
HXDLIN( 404)					int c11 = codes->__get(buf5.cca((i1 - 1)));
HXLINE( 405)					i1 = (i1 + 1);
HXDLIN( 405)					int c2 = codes->__get(buf5.cca((i1 - 1)));
HXLINE( 406)					{
HXLINE( 406)						bpos = (bpos + 1);
HXDLIN( 406)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c11 << 2) | (c2 >> 4))) );
            					}
HXLINE( 407)					i1 = (i1 + 1);
HXDLIN( 407)					int c3 = codes->__get(buf5.cca((i1 - 1)));
HXLINE( 408)					{
HXLINE( 408)						bpos = (bpos + 1);
HXDLIN( 408)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c2 << 4) | (c3 >> 2))) );
            					}
HXLINE( 409)					i1 = (i1 + 1);
HXDLIN( 409)					int c4 = codes->__get(buf5.cca((i1 - 1)));
HXLINE( 410)					{
HXLINE( 410)						bpos = (bpos + 1);
HXDLIN( 410)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c3 << 6) | c4)) );
            					}
            				}
HXLINE( 412)				if ((rest >= 2)) {
HXLINE( 413)					i1 = (i1 + 1);
HXDLIN( 413)					int c12 = codes->__get(buf5.cca((i1 - 1)));
HXLINE( 414)					i1 = (i1 + 1);
HXDLIN( 414)					int c21 = codes->__get(buf5.cca((i1 - 1)));
HXLINE( 415)					{
HXLINE( 415)						bpos = (bpos + 1);
HXDLIN( 415)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c12 << 2) | (c21 >> 4))) );
            					}
HXLINE( 416)					if ((rest == 3)) {
HXLINE( 417)						i1 = (i1 + 1);
HXDLIN( 417)						int c31 = codes->__get(buf5.cca((i1 - 1)));
HXLINE( 418)						{
HXLINE( 418)							bpos = (bpos + 1);
HXDLIN( 418)							bytes->b[(bpos - 1)] = ( (unsigned char)(((c21 << 4) | (c31 >> 2))) );
            						}
            					}
            				}
HXLINE( 422)				 ::haxe::Unserializer _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 422)				_hx_tmp3->pos = (_hx_tmp3->pos + len);
HXLINE( 423)				this->cache->push(bytes);
HXLINE( 424)				return bytes;
            			}
            			break;
            			case (int)116: {
...
HXLINE( 450)		this->pos--;
HXLINE( 451)		::String _hx_tmp15 = ((HX_("Invalid char ",81,66,ec,29) + this->buf.charAt(this->pos)) + HX_(" at position ",0a,c2,01,e0));
HXDLIN( 451)		HX_STACK_DO_THROW((_hx_tmp15 + this->pos));
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Unserializer_obj,initCodes,return )
 ...
 ::Dynamic Unserializer_obj::run(::String v){
            	HX_GC_STACKFRAME(&_hx_pos_f8f88660db87045d_462_run)
HXDLIN( 462)		return  ::haxe::Unserializer_obj::__alloc( HX_CTX ,v)->unserialize();
            	}
