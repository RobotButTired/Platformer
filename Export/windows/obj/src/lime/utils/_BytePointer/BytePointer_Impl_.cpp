...
HXLINE( 105)		 ::lime::utils::ArrayBufferView this1;
...
HXDLIN( 105)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 105)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 105)					_this1->byteOffset = 0;
HXDLIN( 105)					_this1->length = array1->get_length();
HXDLIN( 105)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 105)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 105)					_this1->buffer = this3;
HXDLIN( 105)					_this1->copyFromArray(array1,null());
HXDLIN( 105)					this1 = _this1;
            				}
            				else {
HXDLIN( 105)					if (hx::IsNotNull( view )) {
HXDLIN( 105)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 105)						int elementSize = _this2->bytesPerElement;
HXDLIN( 105)						if ((view->type == _this2->type)) {
HXDLIN( 105)							int srcLength1 = srcData->length;
HXDLIN( 105)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 105)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 105)							_this2->buffer = this4;
HXDLIN( 105)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXDLIN( 105)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 105)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 105)						_this2->byteOffset = 0;
HXDLIN( 105)						_this2->length = srcLength;
HXDLIN( 105)						this1 = _this2;
            					}
            					else {
HXDLIN( 105)						if (hx::IsNotNull( buffer )) {
HXDLIN( 105)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 105)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXDLIN( 105)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 105)							int bufferByteLength = buffer->length;
HXDLIN( 105)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 105)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXDLIN( 105)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXDLIN( 105)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 105)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 105)								if ((newRange > bufferByteLength)) {
HXDLIN( 105)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 105)							_this3->buffer = buffer;
HXDLIN( 105)							_this3->byteOffset = in_byteOffset;
HXDLIN( 105)							_this3->byteLength = newByteLength;
HXDLIN( 105)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 105)							this1 = _this3;
            						}
            						else {
...
HXLINE( 116)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 116)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,5);
...
HXDLIN( 116)					_this1->buffer = this3;
HXDLIN( 116)					_this1->copyFromArray(array1,null());
HXDLIN( 116)					this1 = _this1;
            				}
            				else {
HXLINE( 116)					if (hx::IsNotNull( view )) {
HXLINE( 116)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,5);
...
HXDLIN( 116)						int elementSize = _this2->bytesPerElement;
HXDLIN( 116)						if ((view->type == _this2->type)) {
HXLINE( 116)							int srcLength1 = srcData->length;
HXDLIN( 116)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 116)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 116)							_this2->buffer = this4;
HXDLIN( 116)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 116)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 116)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 116)						_this2->byteOffset = 0;
HXDLIN( 116)						_this2->length = srcLength;
HXDLIN( 116)						this1 = _this2;
            					}
            					else {
HXLINE( 116)						if (hx::IsNotNull( buffer )) {
HXLINE( 116)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,5);
...
HXDLIN( 116)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 116)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 116)							int bufferByteLength = buffer->length;
HXDLIN( 116)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 116)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 116)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 116)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 116)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 116)								if ((newRange > bufferByteLength)) {
HXLINE( 116)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 116)							_this3->buffer = buffer;
HXDLIN( 116)							_this3->byteOffset = in_byteOffset;
HXDLIN( 116)							_this3->byteLength = newByteLength;
HXDLIN( 116)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 116)							this1 = _this3;
            						}
            						else {
...
HXLINE( 127)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 127)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,1);
...
HXLINE( 127)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,1);
...
HXLINE( 127)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,1);
...
HXLINE( 138)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 138)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXDLIN( 138)					_this1->buffer = this3;
HXDLIN( 138)					_this1->copyFromArray(array1,null());
HXDLIN( 138)					this1 = _this1;
            				}
            				else {
HXLINE( 138)					if (hx::IsNotNull( view )) {
HXLINE( 138)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXLINE( 138)							int srcLength1 = srcData->length;
HXDLIN( 138)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 138)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 138)							_this2->buffer = this4;
...
HXLINE( 138)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXLINE( 138)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
...
HXLINE( 149)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 149)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,2);
HXDLIN( 149)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 149)					_this1->byteOffset = 0;
HXDLIN( 149)					_this1->length = array1->get_length();
HXDLIN( 149)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 149)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 149)					_this1->buffer = this3;
HXDLIN( 149)					_this1->copyFromArray(array1,null());
HXDLIN( 149)					this1 = _this1;
            				}
            				else {
HXLINE( 149)					if (hx::IsNotNull( view )) {
HXLINE( 149)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,2);
...
HXDLIN( 149)						int elementSize = _this2->bytesPerElement;
HXDLIN( 149)						if ((view->type == _this2->type)) {
HXLINE( 149)							int srcLength1 = srcData->length;
HXDLIN( 149)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 149)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 149)							_this2->buffer = this4;
HXDLIN( 149)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 149)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 149)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 149)						_this2->byteOffset = 0;
HXDLIN( 149)						_this2->length = srcLength;
HXDLIN( 149)						this1 = _this2;
            					}
            					else {
HXLINE( 149)						if (hx::IsNotNull( buffer )) {
HXLINE( 149)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,2);
...
HXDLIN( 149)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 149)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 149)							int bufferByteLength = buffer->length;
HXDLIN( 149)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 149)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 149)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 149)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 149)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 149)								if ((newRange > bufferByteLength)) {
HXLINE( 149)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 149)							_this3->buffer = buffer;
HXDLIN( 149)							_this3->byteOffset = in_byteOffset;
HXDLIN( 149)							_this3->byteLength = newByteLength;
HXDLIN( 149)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 149)							this1 = _this3;
            						}
            						else {
...
HXLINE( 160)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 160)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,7);
HXDLIN( 160)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 160)					_this1->byteOffset = 0;
HXDLIN( 160)					_this1->length = array1->get_length();
HXDLIN( 160)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 160)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 160)					_this1->buffer = this3;
HXDLIN( 160)					_this1->copyFromArray(array1,null());
HXDLIN( 160)					this1 = _this1;
            				}
            				else {
HXLINE( 160)					if (hx::IsNotNull( view )) {
HXLINE( 160)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,7);
...
HXDLIN( 160)						int elementSize = _this2->bytesPerElement;
HXDLIN( 160)						if ((view->type == _this2->type)) {
HXLINE( 160)							int srcLength1 = srcData->length;
HXDLIN( 160)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 160)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 160)							_this2->buffer = this4;
HXDLIN( 160)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 160)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 160)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 160)						_this2->byteOffset = 0;
HXDLIN( 160)						_this2->length = srcLength;
HXDLIN( 160)						this1 = _this2;
            					}
            					else {
HXLINE( 160)						if (hx::IsNotNull( buffer )) {
HXLINE( 160)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,7);
...
HXDLIN( 160)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 160)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 160)							int bufferByteLength = buffer->length;
HXDLIN( 160)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 160)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 160)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 160)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 160)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 160)								if ((newRange > bufferByteLength)) {
HXLINE( 160)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 160)							_this3->buffer = buffer;
HXDLIN( 160)							_this3->byteOffset = in_byteOffset;
HXDLIN( 160)							_this3->byteLength = newByteLength;
HXDLIN( 160)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 160)							this1 = _this3;
            						}
            						else {
...
HXLINE( 171)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 171)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
HXDLIN( 171)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 171)					_this1->byteOffset = 0;
HXDLIN( 171)					_this1->length = array1->get_length();
HXDLIN( 171)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 171)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 171)					_this1->buffer = this3;
HXDLIN( 171)					_this1->copyFromArray(array1,null());
HXDLIN( 171)					this1 = _this1;
            				}
            				else {
HXLINE( 171)					if (hx::IsNotNull( view )) {
HXLINE( 171)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXDLIN( 171)						int elementSize = _this2->bytesPerElement;
HXDLIN( 171)						if ((view->type == _this2->type)) {
HXLINE( 171)							int srcLength1 = srcData->length;
HXDLIN( 171)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 171)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 171)							_this2->buffer = this4;
HXDLIN( 171)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 171)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 171)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 171)						_this2->byteOffset = 0;
HXDLIN( 171)						_this2->length = srcLength;
HXDLIN( 171)						this1 = _this2;
            					}
            					else {
HXLINE( 171)						if (hx::IsNotNull( buffer )) {
HXLINE( 171)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXDLIN( 171)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 171)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 171)							int bufferByteLength = buffer->length;
HXDLIN( 171)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 171)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 171)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 171)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 171)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 171)								if ((newRange > bufferByteLength)) {
HXLINE( 171)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 171)							_this3->buffer = buffer;
HXDLIN( 171)							_this3->byteOffset = in_byteOffset;
HXDLIN( 171)							_this3->byteLength = newByteLength;
HXDLIN( 171)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 171)							this1 = _this3;
            						}
            						else {
...
HXLINE( 182)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 182)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 182)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 182)					_this1->byteOffset = 0;
HXDLIN( 182)					_this1->length = array1->get_length();
HXDLIN( 182)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 182)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 182)					_this1->buffer = this3;
HXDLIN( 182)					_this1->copyFromArray(array1,null());
HXDLIN( 182)					this1 = _this1;
            				}
            				else {
HXLINE( 182)					if (hx::IsNotNull( view )) {
HXLINE( 182)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 182)						int elementSize = _this2->bytesPerElement;
HXDLIN( 182)						if ((view->type == _this2->type)) {
HXLINE( 182)							int srcLength1 = srcData->length;
HXDLIN( 182)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 182)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 182)							_this2->buffer = this4;
HXDLIN( 182)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 182)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 182)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 182)						_this2->byteOffset = 0;
HXDLIN( 182)						_this2->length = srcLength;
HXDLIN( 182)						this1 = _this2;
            					}
            					else {
HXLINE( 182)						if (hx::IsNotNull( buffer )) {
HXLINE( 182)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 182)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 182)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 182)							int bufferByteLength = buffer->length;
HXDLIN( 182)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 182)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 182)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 182)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 182)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 182)								if ((newRange > bufferByteLength)) {
HXLINE( 182)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 182)							_this3->buffer = buffer;
HXDLIN( 182)							_this3->byteOffset = in_byteOffset;
HXDLIN( 182)							_this3->byteLength = newByteLength;
HXDLIN( 182)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 182)							this1 = _this3;
            						}
            						else {
...
HXLINE( 193)		 ::lime::utils::ArrayBufferView this1;
...
HXLINE( 193)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,9);
HXDLIN( 193)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 193)					_this1->byteOffset = 0;
HXDLIN( 193)					_this1->length = array1->get_length();
HXDLIN( 193)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 193)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 193)					_this1->buffer = this3;
HXDLIN( 193)					_this1->copyFromArray(array1,null());
HXDLIN( 193)					this1 = _this1;
            				}
            				else {
HXLINE( 193)					if (hx::IsNotNull( view )) {
HXLINE( 193)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,9);
...
HXDLIN( 193)						int elementSize = _this2->bytesPerElement;
HXDLIN( 193)						if ((view->type == _this2->type)) {
HXLINE( 193)							int srcLength1 = srcData->length;
HXDLIN( 193)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 193)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 193)							_this2->buffer = this4;
HXDLIN( 193)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 193)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 193)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 193)						_this2->byteOffset = 0;
HXDLIN( 193)						_this2->length = srcLength;
HXDLIN( 193)						this1 = _this2;
            					}
            					else {
HXLINE( 193)						if (hx::IsNotNull( buffer )) {
HXLINE( 193)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,9);
...
HXDLIN( 193)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 193)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 193)							int bufferByteLength = buffer->length;
HXDLIN( 193)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 193)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 193)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 193)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 193)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 193)								if ((newRange > bufferByteLength)) {
HXLINE( 193)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 193)							_this3->buffer = buffer;
HXDLIN( 193)							_this3->byteOffset = in_byteOffset;
HXDLIN( 193)							_this3->byteLength = newByteLength;
HXDLIN( 193)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 193)							this1 = _this3;
            						}
            						else {
