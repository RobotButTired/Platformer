...
HXLINE(  86)				_hx_tmp2 = (rect->y > this->y);
            			}
            			else {
HXLINE(  86)				_hx_tmp2 = false;
            			}
HXDLIN(  86)			if (_hx_tmp2) {
HXLINE(  86)				Float _hx_tmp3 = rect->get_right();
HXDLIN(  86)				_hx_tmp1 = (_hx_tmp3 < this->get_right());
            			}
            			else {
HXLINE(  86)				_hx_tmp1 = false;
            			}
HXDLIN(  86)			if (_hx_tmp1) {
HXLINE(  86)				Float _hx_tmp4 = rect->get_bottom();
HXDLIN(  86)				return (_hx_tmp4 < this->get_bottom());
            			}
            			else {
...
HXLINE(  90)				_hx_tmp6 = (rect->y >= this->y);
            			}
            			else {
HXLINE(  90)				_hx_tmp6 = false;
            			}
HXDLIN(  90)			if (_hx_tmp6) {
HXLINE(  90)				Float _hx_tmp7 = rect->get_right();
HXDLIN(  90)				_hx_tmp5 = (_hx_tmp7 <= this->get_right());
            			}
            			else {
HXLINE(  90)				_hx_tmp5 = false;
            			}
HXDLIN(  90)			if (_hx_tmp5) {
HXLINE(  90)				Float _hx_tmp8 = rect->get_bottom();
HXDLIN(  90)				return (_hx_tmp8 <= this->get_bottom());
            			}
            			else {
...
HXLINE( 200)				_hx_tmp1 = (toUnion->height == 0);
            			}
            			else {
