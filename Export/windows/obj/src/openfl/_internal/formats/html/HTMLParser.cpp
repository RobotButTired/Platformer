...
HXLINE(  54)			 ::openfl::text::_internal::TextFormatRange range = textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
...
HXLINE( 114)							textFormatRanges->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,format,value.length,(value.length + sub.length)));
...
HXLINE( 161)										_hx_tmp3 = hx::IsEq( firstChar,45 );
            									}
            									else {
...
HXLINE( 134)									_hx_tmp4 = !(noLineBreak);
            								}
            								else {
...
HXLINE( 227)								textFormatRanges->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,format,value.length,(value.length + sub.length)));
HXLINE( 228)								value = (value + sub);
HXLINE( 229)								noLineBreak = false;
            							}
            						}
            						else {
HXLINE( 234)							textFormatRanges->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,format,value.length,(value.length + segment1.length)));
...
HXLINE( 243)				textFormatRanges->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,formatStack->__get(0).StaticCast<  ::openfl::text::TextFormat >(),0,0));
            			}
            		}
