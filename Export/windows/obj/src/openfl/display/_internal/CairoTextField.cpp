...
HXLINE( 193)					 ::openfl::text::_internal::TextLayoutGroup group1 = ( ( ::openfl::text::_internal::TextLayoutGroup)(group->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 195)					int group2 = group1->lineIndex;
HXDLIN( 195)					if ((group2 < (textField->get_scrollV() - 1))) {
HXLINE( 195)						continue;
            					}
HXLINE( 196)					int group3 = group1->lineIndex;
HXDLIN( 196)					if ((group3 > (textEngine->get_bottomScrollV() - 1))) {
...
HXLINE( 205)					font = ::openfl::text::_internal::TextEngine_obj::getFontInstance(group1->format);
HXLINE( 207)					bool _hx_tmp13;
HXDLIN( 207)					if (hx::IsNotNull( font )) {
HXLINE( 207)						_hx_tmp13 = hx::IsNotNull( group1->format->size );
            					}
            					else {
HXLINE( 207)						_hx_tmp13 = false;
            					}
...
HXLINE( 241)								 ::openfl::text::_internal::GlyphPosition position = _g4->__get(_g3).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 241)								_g3 = (_g3 + 1);
HXLINE( 243)								bool _hx_tmp14;
HXDLIN( 243)								if (hx::IsNotNull( position )) {
HXLINE( 243)									_hx_tmp14 = (position->glyph == 0);
            								}
            								else {
HXLINE( 243)									_hx_tmp14 = true;
            								}
...
HXLINE( 252)						bool _hx_tmp15;
HXDLIN( 252)						if ((textField->_hx___caretIndex > -1)) {
HXLINE( 252)							_hx_tmp15 = textEngine->selectable;
            						}
            						else {
HXLINE( 252)							_hx_tmp15 = false;
            						}
HXDLIN( 252)						if (_hx_tmp15) {
HXLINE( 254)							if ((textField->_hx___selectionIndex == textField->_hx___caretIndex)) {
HXLINE( 256)								bool _hx_tmp16;
HXDLIN( 256)								bool _hx_tmp17;
HXDLIN( 256)								if (textField->_hx___showCursor) {
HXLINE( 256)									_hx_tmp17 = (group1->startIndex <= textField->_hx___caretIndex);
            								}
            								else {
HXLINE( 256)									_hx_tmp17 = false;
            								}
HXDLIN( 256)								if (_hx_tmp17) {
HXLINE( 256)									_hx_tmp16 = (group1->endIndex >= textField->_hx___caretIndex);
            								}
            								else {
HXLINE( 256)									_hx_tmp16 = false;
            								}
HXDLIN( 256)								if (_hx_tmp16) {
...
HXLINE( 265)												advance1 = group1->positions->__get(i1).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            											}
            											else {
...
HXLINE( 275)									Float _hx_tmp18 = (::Math_obj::floor((group1->offsetX + advance)) + ((Float)0.5));
HXDLIN( 275)									Float _hx_tmp19 = (_hx_tmp18 - ( (Float)(textField->get_scrollH()) ));
HXDLIN( 275)									cairo->moveTo((_hx_tmp19 - bounds->x),((scrollY1 + ((Float)2.5)) - bounds->y));
HXLINE( 276)									cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 277)									Float _hx_tmp20 = (::Math_obj::floor((group1->offsetX + advance)) + ((Float)0.5));
HXDLIN( 277)									Float _hx_tmp21 = (_hx_tmp20 - ( (Float)(textField->get_scrollH()) ));
HXDLIN( 277)									Float _hx_tmp22 = (_hx_tmp21 - bounds->x);
HXLINE( 281)									Float _hx_tmp23 = ((scrollY1 + ::openfl::text::_internal::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - ( (Float)(1) ));
HXLINE( 277)									cairo->lineTo(_hx_tmp22,(_hx_tmp23 - bounds->y));
HXLINE( 285)									cairo->stroke();
            								}
            							}
            							else {
HXLINE( 288)								bool _hx_tmp24;
HXDLIN( 288)								bool _hx_tmp25;
HXDLIN( 288)								bool _hx_tmp26;
HXDLIN( 288)								bool _hx_tmp27;
HXDLIN( 288)								if ((group1->startIndex <= textField->_hx___caretIndex)) {
HXLINE( 288)									_hx_tmp27 = (group1->endIndex >= textField->_hx___caretIndex);
            								}
            								else {
HXLINE( 288)									_hx_tmp27 = false;
            								}
HXDLIN( 288)								if (!(_hx_tmp27)) {
HXLINE( 289)									if ((group1->startIndex <= textField->_hx___selectionIndex)) {
HXLINE( 288)										_hx_tmp26 = (group1->endIndex >= textField->_hx___selectionIndex);
            									}
            									else {
HXLINE( 288)										_hx_tmp26 = false;
            									}
            								}
            								else {
HXLINE( 288)									_hx_tmp26 = true;
            								}
HXDLIN( 288)								if (!(_hx_tmp26)) {
HXLINE( 290)									if ((group1->startIndex > textField->_hx___caretIndex)) {
HXLINE( 288)										_hx_tmp25 = (group1->endIndex < textField->_hx___selectionIndex);
            									}
            									else {
HXLINE( 288)										_hx_tmp25 = false;
            									}
            								}
            								else {
HXLINE( 288)									_hx_tmp25 = true;
            								}
HXDLIN( 288)								if (!(_hx_tmp25)) {
HXLINE( 291)									if ((group1->startIndex > textField->_hx___selectionIndex)) {
HXLINE( 288)										_hx_tmp24 = (group1->endIndex < textField->_hx___caretIndex);
            									}
            									else {
...
HXLINE( 288)									_hx_tmp24 = true;
            								}
HXDLIN( 288)								if (_hx_tmp24) {
HXLINE( 293)									int selectionStart = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(textField->_hx___selectionIndex) ),( (Float)(textField->_hx___caretIndex) )));
HXLINE( 294)									int selectionEnd = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(textField->_hx___selectionIndex) ),( (Float)(textField->_hx___caretIndex) )));
HXLINE( 296)									if ((group1->startIndex > selectionStart)) {
HXLINE( 298)										selectionStart = group1->startIndex;
            									}
HXLINE( 301)									if ((group1->endIndex < selectionEnd)) {
HXLINE( 303)										selectionEnd = group1->endIndex;
            									}
HXLINE( 306)									 ::openfl::geom::Rectangle end;
HXDLIN( 306)									 ::openfl::geom::Rectangle start = textField->getCharBoundaries(selectionStart);
HXLINE( 310)									if ((selectionEnd >= group1->endIndex)) {
HXLINE( 312)										end = textField->getCharBoundaries((group1->endIndex - 1));
HXLINE( 314)										if (hx::IsNotNull( end )) {
HXLINE( 316)											 ::openfl::geom::Rectangle end1 = end;
HXDLIN( 316)											end1->x = (end1->x + (end->width + 2));
            										}
            									}
            									else {
HXLINE( 321)										end = textField->getCharBoundaries(selectionEnd);
            									}
HXLINE( 324)									bool _hx_tmp28;
HXDLIN( 324)									if (hx::IsNotNull( start )) {
HXLINE( 324)										_hx_tmp28 = hx::IsNotNull( end );
            									}
            									else {
HXLINE( 324)										_hx_tmp28 = false;
            									}
HXDLIN( 324)									if (_hx_tmp28) {
HXLINE( 326)										cairo->setSourceRGB(( (Float)(0) ),( (Float)(0) ),( (Float)(0) ));
HXLINE( 327)										cairo->rectangle((scrollX + start->x),(start->y + scrollY),(end->x - start->x),group1->height);
HXLINE( 328)										cairo->fill();
HXLINE( 329)										cairo->setSourceRGB(( (Float)(1) ),( (Float)(1) ),( (Float)(1) ));
HXLINE( 333)										cairo->moveTo((scrollX + start->x),((group1->offsetY + group1->ascent) + scrollY));
HXLINE( 336)										cairo->showText(text.substring(selectionStart,selectionEnd));
            									}
            								}
            							}
            						}
HXLINE( 341)						if (( (bool)(group1->format->underline) )) {
HXLINE( 345)							cairo->newPath();
HXLINE( 346)							cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 347)							Float x1 = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 348)							Float y1 = (::Math_obj::floor((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + ((Float)0.5));
HXLINE( 349)							cairo->moveTo(x1,y1);
HXLINE( 350)							cairo->lineTo((x1 + group1->width),y1);
HXLINE( 351)							cairo->stroke();
HXLINE( 352)							cairo->closePath();
            						}
            					}
            				}
            				_hx_goto_1:;
...
HXLINE( 357)			bool _hx_tmp29;
HXDLIN( 357)			bool _hx_tmp30;
HXDLIN( 357)			if ((textField->_hx___caretIndex > -1)) {
HXLINE( 357)				_hx_tmp30 = textEngine->selectable;
            			}
            			else {
HXLINE( 357)				_hx_tmp30 = false;
            			}
HXDLIN( 357)			if (_hx_tmp30) {
HXLINE( 357)				_hx_tmp29 = textField->_hx___showCursor;
            			}
            			else {
HXLINE( 357)				_hx_tmp29 = false;
            			}
HXDLIN( 357)			if (_hx_tmp29) {
HXLINE( 359)				int scrollX1 = -(textField->get_scrollH());
HXLINE( 360)				Float scrollY2 = ((Float)0.0);
HXLINE( 362)				{
HXLINE( 362)					int _g2 = 0;
HXDLIN( 362)					int _g11 = (textField->get_scrollV() - 1);
HXDLIN( 362)					while((_g2 < _g11)){
HXLINE( 362)						_g2 = (_g2 + 1);
HXDLIN( 362)						int i3 = (_g2 - 1);
HXLINE( 364)						scrollY2 = (scrollY2 + textEngine->lineHeights->get(i3));
            					}
            				}
HXLINE( 367)				 ::Dynamic color3 = textField->get_defaultTextFormat()->color;
HXLINE( 368)				Float r3 = (( (Float)(hx::UShr((( (int)(color3) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 369)				Float g3 = (( (Float)(hx::UShr((( (int)(color3) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 370)				Float b3 = (( (Float)((( (int)(color3) ) & 255)) ) / ( (Float)(255) ));
HXLINE( 372)				cairo->setSourceRGB(r3,g3,b3);
HXLINE( 374)				cairo->newPath();
HXLINE( 375)				cairo->moveTo((scrollX1 + ((Float)2.5)),(scrollY2 + ((Float)2.5)));
HXLINE( 376)				cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 377)				cairo->lineTo((scrollX1 + ((Float)2.5)),((scrollY2 + ::openfl::text::_internal::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - ( (Float)(1) )));
HXLINE( 378)				cairo->stroke();
HXLINE( 379)				cairo->closePath();
            			}
            		}
HXLINE( 382)		graphics->_hx___bitmap->image->dirty = true;
HXLINE( 383)		graphics->_hx___bitmap->image->version++;
HXLINE( 384)		textField->_hx___dirty = false;
HXLINE( 385)		graphics->_hx___softwareDirty = false;
HXLINE( 386)		graphics->set___dirty(false);
            	}
