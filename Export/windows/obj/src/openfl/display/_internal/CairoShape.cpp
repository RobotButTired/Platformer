...
HX_LOCAL_STACK_FRAME(_hx_pos_b1fba0bba755bee2_23_render,"openfl.display._internal.CairoShape","render",0xf0c8232f,"openfl.display._internal.CairoShape.render","openfl/display/_internal/CairoShape.hx",23,0x7720bd06)
HX_LOCAL_STACK_FRAME(_hx_pos_b1fba0bba755bee2_79_render,"openfl.display._internal.CairoShape","render",0xf0c8232f,"openfl.display._internal.CairoShape.render","openfl/display/_internal/CairoShape.hx",79,0x7720bd06)
HX_LOCAL_STACK_FRAME(_hx_pos_b1fba0bba755bee2_18_boot,"openfl.display._internal.CairoShape","boot",0x5e1063cb,"openfl.display._internal.CairoShape.boot","openfl/display/_internal/CairoShape.hx",18,0x7720bd06)
...
void CairoShape_obj::render( ::openfl::display::DisplayObject shape, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b1fba0bba755bee2_23_render)
...
HXLINE(  34)			::openfl::display::_internal::CairoGraphics_obj::render(graphics,renderer);
...
HXDLIN(  48)				if (_hx_tmp3) {
            					...
            					void _hx_run(Float sx,Float sy,Float sWidth,Float sHeight,Float dx,Float dy,Float dWidth,Float dHeight){
            						HX_STACKFRAME(&_hx_pos_b1fba0bba755bee2_79_render)
...
HXLINE(  87)						::openfl::display::_internal::CairoShape_obj::sourceTransform->tx = sx;
HXLINE(  88)						::openfl::display::_internal::CairoShape_obj::sourceTransform->ty = sy;
HXLINE(  89)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_matrix(pattern,::openfl::display::_internal::CairoShape_obj::sourceTransform);
...
{
{
            	HX_STACKFRAME(&_hx_pos_b1fba0bba755bee2_18_boot)
HXDLIN(  18)		__mClass->__meta__ =  ::Dynamic(hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("obj",f7,8f,54,00), ::Dynamic(hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("SuppressWarnings",0c,d3,d2,00),::cpp::VirtualArray_obj::__new(1)->init(0,HX_("checkstyle:FieldDocComment",70,56,1b,20))))));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_b1fba0bba755bee2_20_boot)
