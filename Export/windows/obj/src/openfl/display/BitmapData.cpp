...
HXLINE( 161)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 161)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 161)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXLINE( 161)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            							}
            						}
            					}
            				}
...
HXLINE( 169)				 ::lime::graphics::Image _hx_tmp1 = this->image;
HXDLIN( 169)				_hx_tmp1->fillRect(this->image->get_rect(),fillColor,null());
            			}
...
HXLINE( 324)			_hx_tmp2 = hx::IsNotNull( otherBitmapData->image );
            		}
            		else {
HXLINE( 324)			_hx_tmp2 = false;
            		}
HXDLIN( 324)		if (_hx_tmp2) {
HXLINE( 324)			int _hx_tmp3 = this->image->get_format();
HXDLIN( 324)			_hx_tmp1 = (_hx_tmp3 == otherBitmapData->image->get_format());
            		}
            		else {
...
HXDLIN( 355)			int _g11 = this->height;
HXDLIN( 355)			while((_g2 < _g11)){
HXLINE( 355)				_g2 = (_g2 + 1);
HXDLIN( 355)				int y = (_g2 - 1);
HXLINE( 357)				{
HXLINE( 357)					int _g3 = 0;
HXDLIN( 357)					int _g12 = this->width;
HXDLIN( 357)					while((_g3 < _g12)){
HXLINE( 357)						_g3 = (_g3 + 1);
HXDLIN( 357)						int x = (_g3 - 1);
...
HXDLIN( 375)							if ((r == 0)) {
HXLINE( 375)								_hx_tmp5 = (g == 0);
            							}
            							else {
HXLINE( 375)								_hx_tmp5 = false;
            							}
HXDLIN( 375)							if (_hx_tmp5) {
HXLINE( 375)								_hx_tmp4 = (b == 0);
            							}
            							else {
HXLINE( 375)								_hx_tmp4 = false;
            							}
HXDLIN( 375)							if (_hx_tmp4) {
HXLINE( 377)								a1 = ((hx::UShr(pixel,24) & 255) - (hx::UShr(otherPixel,24) & 255));
HXLINE( 379)								if ((a1 != 0)) {
...
HXLINE( 384)									comparePixel = (((((a1 & 255) << 24) | (((hx::UShr(comparePixel,16) & 255) & 255) << 16)) | (((hx::UShr(comparePixel,8) & 255) & 255) << 8)) | ((comparePixel & 255) & 255));
...
HXLINE( 617)			 ::openfl::display::CairoRenderer renderer1 =  ::openfl::display::CairoRenderer_obj::__alloc( HX_CTX , ::lime::graphics::cairo::Cairo_obj::__alloc( HX_CTX ,this->getSurface()));
HXLINE( 620)			renderer1->_hx___allowSmoothing = smoothing;
HXLINE( 621)			renderer1->_hx___overrideBlendMode = blendMode;
HXLINE( 623)			renderer1->_hx___worldTransform = transform;
HXLINE( 624)			renderer1->_hx___worldAlpha = (( (Float)(1) ) / ( (Float)(source->__Field(HX_("__worldAlpha",cc,d2,d6,c5),hx::paccDynamic)) ));
HXLINE( 625)			renderer1->_hx___worldColorTransform = _colorTransform;
HXLINE( 627)			if (hx::IsNotNull( clipRect )) {
HXLINE( 629)				renderer1->_hx___pushMaskRect(clipRect,clipMatrix);
            			}
HXLINE( 635)			this->_hx___drawCairo(source,renderer1);
HXLINE( 638)			if (hx::IsNotNull( clipRect )) {
HXLINE( 640)				renderer1->_hx___popMaskRect();
...
HXLINE( 677)		if (::Std_obj::is(compressor,hx::ClassOf< ::openfl::display::PNGEncoderOptions >())) {
...
HXLINE( 682)			if (::Std_obj::is(compressor,hx::ClassOf< ::openfl::display::JPEGEncoderOptions >())) {
...
HXLINE( 894)					bool _hx_tmp4;
HXDLIN( 894)					if ((centerX == 0)) {
HXLINE( 894)						_hx_tmp4 = (centerY != 0);
            					}
            					else {
HXLINE( 894)						_hx_tmp4 = false;
            					}
HXDLIN( 894)					if (_hx_tmp4) {
HXLINE( 896)						 ::haxe::io::Bytes buffer1 = null();
HXDLIN( 896)						::cpp::VirtualArray array1 = null();
HXDLIN( 896)						 ::openfl::_Vector::IntVector vector1 = null();
HXDLIN( 896)						 ::lime::utils::ArrayBufferView view1 = null();
HXDLIN( 896)						 ::Dynamic len1 = null();
HXDLIN( 896)						 ::lime::utils::ArrayBufferView this56 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,18,6);
HXDLIN( 896)						this->_hx___indexBufferData = this56;
HXLINE( 907)						{
HXLINE( 907)							 ::lime::utils::ArrayBufferView this57 = this->_hx___indexBufferData;
HXDLIN( 907)							 ::__hxcpp_memory_set_ui16(this57->buffer->b,this57->byteOffset,0);
            						}
HXLINE( 908)						{
HXLINE( 908)							 ::lime::utils::ArrayBufferView this58 = this->_hx___indexBufferData;
HXDLIN( 908)							 ::__hxcpp_memory_set_ui16(this58->buffer->b,(this58->byteOffset + 2),1);
            						}
HXLINE( 909)						{
HXLINE( 909)							 ::lime::utils::ArrayBufferView this59 = this->_hx___indexBufferData;
HXDLIN( 909)							 ::__hxcpp_memory_set_ui16(this59->buffer->b,(this59->byteOffset + 4),2);
            						}
HXLINE( 910)						{
HXLINE( 910)							 ::lime::utils::ArrayBufferView this60 = this->_hx___indexBufferData;
HXDLIN( 910)							 ::__hxcpp_memory_set_ui16(this60->buffer->b,(this60->byteOffset + 6),2);
            						}
HXLINE( 911)						{
HXLINE( 911)							 ::lime::utils::ArrayBufferView this61 = this->_hx___indexBufferData;
HXDLIN( 911)							 ::__hxcpp_memory_set_ui16(this61->buffer->b,(this61->byteOffset + 8),1);
            						}
HXLINE( 912)						{
HXLINE( 912)							 ::lime::utils::ArrayBufferView this62 = this->_hx___indexBufferData;
HXDLIN( 912)							 ::__hxcpp_memory_set_ui16(this62->buffer->b,(this62->byteOffset + 10),3);
            						}
HXLINE( 915)						{
HXLINE( 915)							 ::lime::utils::ArrayBufferView this63 = this->_hx___indexBufferData;
HXDLIN( 915)							 ::__hxcpp_memory_set_ui16(this63->buffer->b,(this63->byteOffset + 12),4);
            						}
HXLINE( 916)						{
HXLINE( 916)							 ::lime::utils::ArrayBufferView this64 = this->_hx___indexBufferData;
HXDLIN( 916)							 ::__hxcpp_memory_set_ui16(this64->buffer->b,(this64->byteOffset + 14),5);
            						}
HXLINE( 917)						{
HXLINE( 917)							 ::lime::utils::ArrayBufferView this65 = this->_hx___indexBufferData;
HXDLIN( 917)							 ::__hxcpp_memory_set_ui16(this65->buffer->b,(this65->byteOffset + 16),0);
            						}
HXLINE( 918)						{
HXLINE( 918)							 ::lime::utils::ArrayBufferView this66 = this->_hx___indexBufferData;
HXDLIN( 918)							 ::__hxcpp_memory_set_ui16(this66->buffer->b,(this66->byteOffset + 18),0);
            						}
HXLINE( 919)						{
HXLINE( 919)							 ::lime::utils::ArrayBufferView this67 = this->_hx___indexBufferData;
HXDLIN( 919)							 ::__hxcpp_memory_set_ui16(this67->buffer->b,(this67->byteOffset + 20),5);
            						}
HXLINE( 920)						{
HXLINE( 920)							 ::lime::utils::ArrayBufferView this68 = this->_hx___indexBufferData;
HXDLIN( 920)							 ::__hxcpp_memory_set_ui16(this68->buffer->b,(this68->byteOffset + 22),1);
            						}
HXLINE( 923)						{
HXLINE( 923)							 ::lime::utils::ArrayBufferView this69 = this->_hx___indexBufferData;
HXDLIN( 923)							 ::__hxcpp_memory_set_ui16(this69->buffer->b,(this69->byteOffset + 24),6);
            						}
HXLINE( 924)						{
HXLINE( 924)							 ::lime::utils::ArrayBufferView this70 = this->_hx___indexBufferData;
HXDLIN( 924)							 ::__hxcpp_memory_set_ui16(this70->buffer->b,(this70->byteOffset + 26),7);
            						}
HXLINE( 925)						{
HXLINE( 925)							 ::lime::utils::ArrayBufferView this71 = this->_hx___indexBufferData;
HXDLIN( 925)							 ::__hxcpp_memory_set_ui16(this71->buffer->b,(this71->byteOffset + 28),4);
            						}
HXLINE( 926)						{
HXLINE( 926)							 ::lime::utils::ArrayBufferView this72 = this->_hx___indexBufferData;
HXDLIN( 926)							 ::__hxcpp_memory_set_ui16(this72->buffer->b,(this72->byteOffset + 30),4);
            						}
HXLINE( 927)						{
HXLINE( 927)							 ::lime::utils::ArrayBufferView this73 = this->_hx___indexBufferData;
HXDLIN( 927)							 ::__hxcpp_memory_set_ui16(this73->buffer->b,(this73->byteOffset + 32),7);
            						}
HXLINE( 928)						{
HXLINE( 928)							 ::lime::utils::ArrayBufferView this74 = this->_hx___indexBufferData;
HXDLIN( 928)							 ::__hxcpp_memory_set_ui16(this74->buffer->b,(this74->byteOffset + 34),5);
            						}
HXLINE( 930)						this->_hx___indexBuffer = context->createIndexBuffer(18,null());
            					}
            					else {
HXLINE( 932)						bool _hx_tmp5;
HXDLIN( 932)						if ((centerX != 0)) {
HXLINE( 932)							_hx_tmp5 = (centerY == 0);
            						}
            						else {
HXLINE( 932)							_hx_tmp5 = false;
            						}
HXDLIN( 932)						if (_hx_tmp5) {
HXLINE( 934)							 ::haxe::io::Bytes buffer2 = null();
HXDLIN( 934)							::cpp::VirtualArray array2 = null();
HXDLIN( 934)							 ::openfl::_Vector::IntVector vector2 = null();
HXDLIN( 934)							 ::lime::utils::ArrayBufferView view2 = null();
HXDLIN( 934)							 ::Dynamic len2 = null();
HXDLIN( 934)							 ::lime::utils::ArrayBufferView this75 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,18,6);
HXDLIN( 934)							this->_hx___indexBufferData = this75;
HXLINE( 941)							{
HXLINE( 941)								 ::lime::utils::ArrayBufferView this76 = this->_hx___indexBufferData;
HXDLIN( 941)								 ::__hxcpp_memory_set_ui16(this76->buffer->b,this76->byteOffset,0);
            							}
HXLINE( 942)							{
HXLINE( 942)								 ::lime::utils::ArrayBufferView this77 = this->_hx___indexBufferData;
HXDLIN( 942)								 ::__hxcpp_memory_set_ui16(this77->buffer->b,(this77->byteOffset + 2),1);
            							}
HXLINE( 943)							{
HXLINE( 943)								 ::lime::utils::ArrayBufferView this78 = this->_hx___indexBufferData;
HXDLIN( 943)								 ::__hxcpp_memory_set_ui16(this78->buffer->b,(this78->byteOffset + 4),2);
            							}
HXLINE( 944)							{
HXLINE( 944)								 ::lime::utils::ArrayBufferView this79 = this->_hx___indexBufferData;
HXDLIN( 944)								 ::__hxcpp_memory_set_ui16(this79->buffer->b,(this79->byteOffset + 6),2);
            							}
HXLINE( 945)							{
HXLINE( 945)								 ::lime::utils::ArrayBufferView this80 = this->_hx___indexBufferData;
HXDLIN( 945)								 ::__hxcpp_memory_set_ui16(this80->buffer->b,(this80->byteOffset + 8),1);
            							}
HXLINE( 946)							{
HXLINE( 946)								 ::lime::utils::ArrayBufferView this81 = this->_hx___indexBufferData;
HXDLIN( 946)								 ::__hxcpp_memory_set_ui16(this81->buffer->b,(this81->byteOffset + 10),3);
            							}
HXLINE( 949)							{
HXLINE( 949)								 ::lime::utils::ArrayBufferView this82 = this->_hx___indexBufferData;
HXDLIN( 949)								 ::__hxcpp_memory_set_ui16(this82->buffer->b,(this82->byteOffset + 12),4);
            							}
HXLINE( 950)							{
HXLINE( 950)								 ::lime::utils::ArrayBufferView this83 = this->_hx___indexBufferData;
HXDLIN( 950)								 ::__hxcpp_memory_set_ui16(this83->buffer->b,(this83->byteOffset + 14),0);
            							}
HXLINE( 951)							{
HXLINE( 951)								 ::lime::utils::ArrayBufferView this84 = this->_hx___indexBufferData;
HXDLIN( 951)								 ::__hxcpp_memory_set_ui16(this84->buffer->b,(this84->byteOffset + 16),5);
            							}
HXLINE( 952)							{
HXLINE( 952)								 ::lime::utils::ArrayBufferView this85 = this->_hx___indexBufferData;
HXDLIN( 952)								 ::__hxcpp_memory_set_ui16(this85->buffer->b,(this85->byteOffset + 18),5);
            							}
HXLINE( 953)							{
HXLINE( 953)								 ::lime::utils::ArrayBufferView this86 = this->_hx___indexBufferData;
HXDLIN( 953)								 ::__hxcpp_memory_set_ui16(this86->buffer->b,(this86->byteOffset + 20),0);
            							}
HXLINE( 954)							{
HXLINE( 954)								 ::lime::utils::ArrayBufferView this87 = this->_hx___indexBufferData;
HXDLIN( 954)								 ::__hxcpp_memory_set_ui16(this87->buffer->b,(this87->byteOffset + 22),2);
            							}
HXLINE( 957)							{
HXLINE( 957)								 ::lime::utils::ArrayBufferView this88 = this->_hx___indexBufferData;
HXDLIN( 957)								 ::__hxcpp_memory_set_ui16(this88->buffer->b,(this88->byteOffset + 24),6);
            							}
HXLINE( 958)							{
HXLINE( 958)								 ::lime::utils::ArrayBufferView this89 = this->_hx___indexBufferData;
HXDLIN( 958)								 ::__hxcpp_memory_set_ui16(this89->buffer->b,(this89->byteOffset + 26),4);
            							}
HXLINE( 959)							{
HXLINE( 959)								 ::lime::utils::ArrayBufferView this90 = this->_hx___indexBufferData;
HXDLIN( 959)								 ::__hxcpp_memory_set_ui16(this90->buffer->b,(this90->byteOffset + 28),7);
            							}
HXLINE( 960)							{
HXLINE( 960)								 ::lime::utils::ArrayBufferView this91 = this->_hx___indexBufferData;
HXDLIN( 960)								 ::__hxcpp_memory_set_ui16(this91->buffer->b,(this91->byteOffset + 30),7);
            							}
HXLINE( 961)							{
HXLINE( 961)								 ::lime::utils::ArrayBufferView this92 = this->_hx___indexBufferData;
HXDLIN( 961)								 ::__hxcpp_memory_set_ui16(this92->buffer->b,(this92->byteOffset + 32),4);
            							}
HXLINE( 962)							{
HXLINE( 962)								 ::lime::utils::ArrayBufferView this93 = this->_hx___indexBufferData;
HXDLIN( 962)								 ::__hxcpp_memory_set_ui16(this93->buffer->b,(this93->byteOffset + 34),5);
            							}
...
HXLINE( 974)				 ::haxe::io::Bytes buffer3 = null();
HXDLIN( 974)				::cpp::VirtualArray array3 = null();
HXDLIN( 974)				 ::openfl::_Vector::IntVector vector3 = null();
HXDLIN( 974)				 ::lime::utils::ArrayBufferView view3 = null();
HXDLIN( 974)				 ::Dynamic len3 = null();
HXDLIN( 974)				 ::lime::utils::ArrayBufferView this94 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,6,6);
HXDLIN( 974)				this->_hx___indexBufferData = this94;
HXLINE( 975)				{
HXLINE( 975)					 ::lime::utils::ArrayBufferView this95 = this->_hx___indexBufferData;
HXDLIN( 975)					 ::__hxcpp_memory_set_ui16(this95->buffer->b,this95->byteOffset,0);
            				}
HXLINE( 976)				{
HXLINE( 976)					 ::lime::utils::ArrayBufferView this96 = this->_hx___indexBufferData;
HXDLIN( 976)					 ::__hxcpp_memory_set_ui16(this96->buffer->b,(this96->byteOffset + 2),1);
            				}
HXLINE( 977)				{
HXLINE( 977)					 ::lime::utils::ArrayBufferView this97 = this->_hx___indexBufferData;
HXDLIN( 977)					 ::__hxcpp_memory_set_ui16(this97->buffer->b,(this97->byteOffset + 4),2);
            				}
HXLINE( 978)				{
HXLINE( 978)					 ::lime::utils::ArrayBufferView this98 = this->_hx___indexBufferData;
HXDLIN( 978)					 ::__hxcpp_memory_set_ui16(this98->buffer->b,(this98->byteOffset + 6),2);
            				}
HXLINE( 979)				{
HXLINE( 979)					 ::lime::utils::ArrayBufferView this99 = this->_hx___indexBufferData;
HXDLIN( 979)					 ::__hxcpp_memory_set_ui16(this99->buffer->b,(this99->byteOffset + 8),1);
            				}
HXLINE( 980)				{
HXLINE( 980)					 ::lime::utils::ArrayBufferView this100 = this->_hx___indexBufferData;
HXDLIN( 980)					 ::__hxcpp_memory_set_ui16(this100->buffer->b,(this100->byteOffset + 10),3);
            				}
...
HXLINE(1003)				bool _hx_tmp4;
HXDLIN(1003)				bool _hx_tmp5;
HXDLIN(1003)				Float _hx_tmp6 = this->_hx___vertexBufferWidth;
HXDLIN(1003)				if ((_hx_tmp6 == targetObject->get_width())) {
HXLINE(1004)					Float _hx_tmp7 = this->_hx___vertexBufferHeight;
HXLINE(1003)					_hx_tmp5 = (_hx_tmp7 != targetObject->get_height());
            				}
            				else {
HXLINE(1003)					_hx_tmp5 = true;
            				}
HXDLIN(1003)				if (!(_hx_tmp5)) {
HXLINE(1005)					Float _hx_tmp8 = this->_hx___vertexBufferScaleX;
HXLINE(1003)					_hx_tmp4 = (_hx_tmp8 != targetObject->get_scaleX());
            				}
            				else {
HXLINE(1003)					_hx_tmp4 = true;
            				}
HXDLIN(1003)				if (!(_hx_tmp4)) {
HXLINE(1006)					Float _hx_tmp9 = this->_hx___vertexBufferScaleY;
HXLINE( 998)					_hx_tmp = (_hx_tmp9 != targetObject->get_scaleY());
            				}
            				else {
...
HXLINE(1061)				_hx_tmp10 = hx::IsNotNull( targetObject );
            			}
            			else {
...
HXLINE(1073)				bool _hx_tmp11;
HXDLIN(1073)				if ((centerX != 0)) {
HXLINE(1073)					_hx_tmp11 = (centerY != 0);
            				}
            				else {
HXLINE(1073)					_hx_tmp11 = false;
            				}
HXDLIN(1073)				if (_hx_tmp11) {
...
HXLINE(1178)					bool _hx_tmp12;
HXDLIN(1178)					if ((centerX == 0)) {
HXLINE(1178)						_hx_tmp12 = (centerY != 0);
            					}
            					else {
HXLINE(1178)						_hx_tmp12 = false;
            					}
HXDLIN(1178)					if (_hx_tmp12) {
HXLINE(1180)						 ::haxe::io::Bytes buffer1 = null();
HXDLIN(1180)						::cpp::VirtualArray array1 = null();
HXDLIN(1180)						 ::openfl::_Vector::FloatVector vector1 = null();
HXDLIN(1180)						 ::lime::utils::ArrayBufferView view1 = null();
HXDLIN(1180)						 ::Dynamic len1 = null();
HXDLIN(1180)						 ::lime::utils::ArrayBufferView this50 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,112,8);
HXDLIN(1180)						this->_hx___vertexBufferData = this50;
HXLINE(1182)						Float top1 = scale9Grid->y;
HXLINE(1183)						Float bottom1 = ((( (Float)(this->height) ) - centerY) - top1);
HXLINE(1185)						Float uvTop1 = (top1 / ( (Float)(this->height) ));
HXLINE(1186)						Float uvCenterY1 = (centerY / ( (Float)(this->height) ));
HXLINE(1187)						Float uvBottom1 = (bottom1 / ( (Float)(this->height) ));
HXLINE(1189)						Float renderedTop1 = (top1 / targetObject->get_scaleY());
HXLINE(1190)						Float renderedBottom1 = (bottom1 / targetObject->get_scaleY());
HXLINE(1191)						Float renderedCenterY2 = targetObject->get_height();
HXDLIN(1191)						Float renderedCenterY3 = (((renderedCenterY2 / targetObject->get_scaleY()) - renderedTop1) - renderedBottom1);
...
HXLINE(1204)						{
HXLINE(1204)							 ::lime::utils::ArrayBufferView this51 = this->_hx___vertexBufferData;
HXDLIN(1204)							 ::__hxcpp_memory_set_float(this51->buffer->b,this51->byteOffset,renderedWidth1);
            						}
HXLINE(1205)						{
HXLINE(1205)							 ::lime::utils::ArrayBufferView this52 = this->_hx___vertexBufferData;
HXDLIN(1205)							 ::__hxcpp_memory_set_float(this52->buffer->b,(this52->byteOffset + 4),renderedTop1);
            						}
HXLINE(1206)						{
HXLINE(1206)							 ::lime::utils::ArrayBufferView this53 = this->_hx___vertexBufferData;
HXDLIN(1206)							 ::__hxcpp_memory_set_float(this53->buffer->b,(this53->byteOffset + 12),uvWidth);
            						}
HXLINE(1207)						{
HXLINE(1207)							 ::lime::utils::ArrayBufferView this54 = this->_hx___vertexBufferData;
HXDLIN(1207)							Float val32 = (( (Float)(uvHeight) ) * uvTop1);
HXDLIN(1207)							 ::__hxcpp_memory_set_float(this54->buffer->b,(this54->byteOffset + 16),val32);
            						}
HXLINE(1209)						{
HXLINE(1209)							 ::lime::utils::ArrayBufferView this55 = this->_hx___vertexBufferData;
HXDLIN(1209)							 ::__hxcpp_memory_set_float(this55->buffer->b,(this55->byteOffset + 60),renderedTop1);
            						}
HXLINE(1210)						{
HXLINE(1210)							 ::lime::utils::ArrayBufferView this56 = this->_hx___vertexBufferData;
HXDLIN(1210)							Float val33 = (( (Float)(uvHeight) ) * uvTop1);
HXDLIN(1210)							 ::__hxcpp_memory_set_float(this56->buffer->b,(this56->byteOffset + 72),val33);
            						}
HXLINE(1212)						{
HXLINE(1212)							 ::lime::utils::ArrayBufferView this57 = this->_hx___vertexBufferData;
HXDLIN(1212)							 ::__hxcpp_memory_set_float(this57->buffer->b,(this57->byteOffset + 112),renderedWidth1);
            						}
HXLINE(1213)						{
HXLINE(1213)							 ::lime::utils::ArrayBufferView this58 = this->_hx___vertexBufferData;
HXDLIN(1213)							 ::__hxcpp_memory_set_float(this58->buffer->b,(this58->byteOffset + 124),uvWidth);
            						}
HXLINE(1216)						{
HXLINE(1216)							 ::lime::utils::ArrayBufferView this59 = this->_hx___vertexBufferData;
HXDLIN(1216)							 ::__hxcpp_memory_set_float(this59->buffer->b,(this59->byteOffset + 224),renderedWidth1);
            						}
HXLINE(1217)						{
HXLINE(1217)							 ::lime::utils::ArrayBufferView this60 = this->_hx___vertexBufferData;
HXDLIN(1217)							Float val34 = (renderedTop1 + renderedCenterY3);
HXDLIN(1217)							 ::__hxcpp_memory_set_float(this60->buffer->b,(this60->byteOffset + 228),val34);
            						}
HXLINE(1218)						{
HXLINE(1218)							 ::lime::utils::ArrayBufferView this61 = this->_hx___vertexBufferData;
HXDLIN(1218)							 ::__hxcpp_memory_set_float(this61->buffer->b,(this61->byteOffset + 236),uvWidth);
            						}
HXLINE(1219)						{
HXLINE(1219)							 ::lime::utils::ArrayBufferView this62 = this->_hx___vertexBufferData;
HXDLIN(1219)							Float val35 = (( (Float)(uvHeight) ) * (uvTop1 + uvCenterY1));
HXDLIN(1219)							 ::__hxcpp_memory_set_float(this62->buffer->b,(this62->byteOffset + 240),val35);
            						}
HXLINE(1221)						{
HXLINE(1221)							 ::lime::utils::ArrayBufferView this63 = this->_hx___vertexBufferData;
HXDLIN(1221)							Float val36 = (renderedTop1 + renderedCenterY3);
HXDLIN(1221)							 ::__hxcpp_memory_set_float(this63->buffer->b,(this63->byteOffset + 284),val36);
            						}
HXLINE(1222)						{
HXLINE(1222)							 ::lime::utils::ArrayBufferView this64 = this->_hx___vertexBufferData;
HXDLIN(1222)							Float val37 = (( (Float)(uvHeight) ) * (uvTop1 + uvCenterY1));
HXDLIN(1222)							 ::__hxcpp_memory_set_float(this64->buffer->b,(this64->byteOffset + 296),val37);
            						}
HXLINE(1225)						{
HXLINE(1225)							 ::lime::utils::ArrayBufferView this65 = this->_hx___vertexBufferData;
HXDLIN(1225)							 ::__hxcpp_memory_set_float(this65->buffer->b,(this65->byteOffset + 336),renderedWidth1);
            						}
HXLINE(1226)						{
HXLINE(1226)							 ::lime::utils::ArrayBufferView this66 = this->_hx___vertexBufferData;
HXDLIN(1226)							Float val38 = ( (Float)(this->height) );
HXDLIN(1226)							 ::__hxcpp_memory_set_float(this66->buffer->b,(this66->byteOffset + 340),val38);
            						}
HXLINE(1227)						{
HXLINE(1227)							 ::lime::utils::ArrayBufferView this67 = this->_hx___vertexBufferData;
HXDLIN(1227)							 ::__hxcpp_memory_set_float(this67->buffer->b,(this67->byteOffset + 348),uvWidth);
            						}
HXLINE(1228)						{
HXLINE(1228)							 ::lime::utils::ArrayBufferView this68 = this->_hx___vertexBufferData;
HXDLIN(1228)							 ::__hxcpp_memory_set_float(this68->buffer->b,(this68->byteOffset + 352),uvHeight);
            						}
HXLINE(1230)						{
HXLINE(1230)							 ::lime::utils::ArrayBufferView this69 = this->_hx___vertexBufferData;
HXDLIN(1230)							Float val39 = ( (Float)(this->height) );
HXDLIN(1230)							 ::__hxcpp_memory_set_float(this69->buffer->b,(this69->byteOffset + 396),val39);
            						}
HXLINE(1231)						{
HXLINE(1231)							 ::lime::utils::ArrayBufferView this70 = this->_hx___vertexBufferData;
HXDLIN(1231)							 ::__hxcpp_memory_set_float(this70->buffer->b,(this70->byteOffset + 408),uvHeight);
            						}
HXLINE(1233)						this->_hx___vertexBuffer = context->createVertexBuffer(8,14,null());
            					}
            					else {
HXLINE(1235)						bool _hx_tmp13;
HXDLIN(1235)						if ((centerY == 0)) {
HXLINE(1235)							_hx_tmp13 = (centerX != 0);
            						}
            						else {
HXLINE(1235)							_hx_tmp13 = false;
            						}
HXDLIN(1235)						if (_hx_tmp13) {
HXLINE(1237)							 ::haxe::io::Bytes buffer2 = null();
HXDLIN(1237)							::cpp::VirtualArray array2 = null();
HXDLIN(1237)							 ::openfl::_Vector::FloatVector vector2 = null();
HXDLIN(1237)							 ::lime::utils::ArrayBufferView view2 = null();
HXDLIN(1237)							 ::Dynamic len2 = null();
HXDLIN(1237)							 ::lime::utils::ArrayBufferView this71 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,112,8);
HXDLIN(1237)							this->_hx___vertexBufferData = this71;
HXLINE(1239)							Float left1 = scale9Grid->x;
HXLINE(1240)							Float right1 = ((( (Float)(this->width) ) - centerX) - left1);
HXLINE(1242)							Float uvLeft1 = (left1 / ( (Float)(this->width) ));
HXLINE(1243)							Float uvCenterX1 = (centerX / ( (Float)(this->width) ));
HXLINE(1244)							Float uvRight1 = (right1 / ( (Float)(this->width) ));
HXLINE(1246)							Float renderedLeft1 = (left1 / targetObject->get_scaleX());
HXLINE(1247)							Float renderedRight1 = (right1 / targetObject->get_scaleX());
HXLINE(1248)							Float renderedCenterX2 = targetObject->get_width();
HXDLIN(1248)							Float renderedCenterX3 = (((renderedCenterX2 / targetObject->get_scaleX()) - renderedLeft1) - renderedRight1);
...
HXLINE(1257)							{
HXLINE(1257)								 ::lime::utils::ArrayBufferView this72 = this->_hx___vertexBufferData;
HXDLIN(1257)								 ::__hxcpp_memory_set_float(this72->buffer->b,this72->byteOffset,renderedLeft1);
            							}
HXLINE(1258)							{
HXLINE(1258)								 ::lime::utils::ArrayBufferView this73 = this->_hx___vertexBufferData;
HXDLIN(1258)								 ::__hxcpp_memory_set_float(this73->buffer->b,(this73->byteOffset + 4),renderedHeight1);
            							}
HXLINE(1259)							{
HXLINE(1259)								 ::lime::utils::ArrayBufferView this74 = this->_hx___vertexBufferData;
HXDLIN(1259)								Float val40 = (( (Float)(uvWidth) ) * uvLeft1);
HXDLIN(1259)								 ::__hxcpp_memory_set_float(this74->buffer->b,(this74->byteOffset + 12),val40);
            							}
HXLINE(1260)							{
HXLINE(1260)								 ::lime::utils::ArrayBufferView this75 = this->_hx___vertexBufferData;
HXDLIN(1260)								 ::__hxcpp_memory_set_float(this75->buffer->b,(this75->byteOffset + 16),uvHeight);
            							}
HXLINE(1262)							{
HXLINE(1262)								 ::lime::utils::ArrayBufferView this76 = this->_hx___vertexBufferData;
HXDLIN(1262)								 ::__hxcpp_memory_set_float(this76->buffer->b,(this76->byteOffset + 60),renderedHeight1);
            							}
HXLINE(1263)							{
HXLINE(1263)								 ::lime::utils::ArrayBufferView this77 = this->_hx___vertexBufferData;
HXDLIN(1263)								 ::__hxcpp_memory_set_float(this77->buffer->b,(this77->byteOffset + 72),uvHeight);
            							}
HXLINE(1265)							{
HXLINE(1265)								 ::lime::utils::ArrayBufferView this78 = this->_hx___vertexBufferData;
HXDLIN(1265)								 ::__hxcpp_memory_set_float(this78->buffer->b,(this78->byteOffset + 112),renderedLeft1);
            							}
HXLINE(1266)							{
HXLINE(1266)								 ::lime::utils::ArrayBufferView this79 = this->_hx___vertexBufferData;
HXDLIN(1266)								Float val41 = (( (Float)(uvWidth) ) * uvLeft1);
HXDLIN(1266)								 ::__hxcpp_memory_set_float(this79->buffer->b,(this79->byteOffset + 124),val41);
            							}
HXLINE(1269)							{
HXLINE(1269)								 ::lime::utils::ArrayBufferView this80 = this->_hx___vertexBufferData;
HXDLIN(1269)								Float val42 = (renderedLeft1 + renderedCenterX3);
HXDLIN(1269)								 ::__hxcpp_memory_set_float(this80->buffer->b,(this80->byteOffset + 224),val42);
            							}
HXLINE(1270)							{
HXLINE(1270)								 ::lime::utils::ArrayBufferView this81 = this->_hx___vertexBufferData;
HXDLIN(1270)								 ::__hxcpp_memory_set_float(this81->buffer->b,(this81->byteOffset + 228),renderedHeight1);
            							}
HXLINE(1271)							{
HXLINE(1271)								 ::lime::utils::ArrayBufferView this82 = this->_hx___vertexBufferData;
HXDLIN(1271)								Float val43 = (( (Float)(uvWidth) ) * (uvLeft1 + uvCenterX1));
HXDLIN(1271)								 ::__hxcpp_memory_set_float(this82->buffer->b,(this82->byteOffset + 236),val43);
            							}
HXLINE(1272)							{
HXLINE(1272)								 ::lime::utils::ArrayBufferView this83 = this->_hx___vertexBufferData;
HXDLIN(1272)								 ::__hxcpp_memory_set_float(this83->buffer->b,(this83->byteOffset + 240),uvHeight);
            							}
HXLINE(1274)							{
HXLINE(1274)								 ::lime::utils::ArrayBufferView this84 = this->_hx___vertexBufferData;
HXDLIN(1274)								Float val44 = (renderedLeft1 + renderedCenterX3);
HXDLIN(1274)								 ::__hxcpp_memory_set_float(this84->buffer->b,(this84->byteOffset + 280),val44);
            							}
HXLINE(1275)							{
HXLINE(1275)								 ::lime::utils::ArrayBufferView this85 = this->_hx___vertexBufferData;
HXDLIN(1275)								Float val45 = (( (Float)(uvWidth) ) * (uvLeft1 + uvCenterX1));
HXDLIN(1275)								 ::__hxcpp_memory_set_float(this85->buffer->b,(this85->byteOffset + 292),val45);
            							}
HXLINE(1278)							{
HXLINE(1278)								 ::lime::utils::ArrayBufferView this86 = this->_hx___vertexBufferData;
HXDLIN(1278)								Float val46 = ( (Float)(this->width) );
HXDLIN(1278)								 ::__hxcpp_memory_set_float(this86->buffer->b,(this86->byteOffset + 336),val46);
            							}
HXLINE(1279)							{
HXLINE(1279)								 ::lime::utils::ArrayBufferView this87 = this->_hx___vertexBufferData;
HXDLIN(1279)								 ::__hxcpp_memory_set_float(this87->buffer->b,(this87->byteOffset + 340),renderedHeight1);
            							}
HXLINE(1280)							{
HXLINE(1280)								 ::lime::utils::ArrayBufferView this88 = this->_hx___vertexBufferData;
HXDLIN(1280)								 ::__hxcpp_memory_set_float(this88->buffer->b,(this88->byteOffset + 348),uvWidth);
            							}
HXLINE(1281)							{
HXLINE(1281)								 ::lime::utils::ArrayBufferView this89 = this->_hx___vertexBufferData;
HXDLIN(1281)								 ::__hxcpp_memory_set_float(this89->buffer->b,(this89->byteOffset + 352),uvHeight);
            							}
HXLINE(1283)							{
HXLINE(1283)								 ::lime::utils::ArrayBufferView this90 = this->_hx___vertexBufferData;
HXDLIN(1283)								Float val47 = ( (Float)(this->width) );
HXDLIN(1283)								 ::__hxcpp_memory_set_float(this90->buffer->b,(this90->byteOffset + 392),val47);
            							}
HXLINE(1284)							{
HXLINE(1284)								 ::lime::utils::ArrayBufferView this91 = this->_hx___vertexBufferData;
HXDLIN(1284)								 ::__hxcpp_memory_set_float(this91->buffer->b,(this91->byteOffset + 404),uvWidth);
            							}
...
HXLINE(1296)				 ::haxe::io::Bytes buffer3 = null();
HXDLIN(1296)				::cpp::VirtualArray array3 = null();
HXDLIN(1296)				 ::openfl::_Vector::FloatVector vector3 = null();
HXDLIN(1296)				 ::lime::utils::ArrayBufferView view3 = null();
HXDLIN(1296)				 ::Dynamic len3 = null();
HXDLIN(1296)				 ::lime::utils::ArrayBufferView this92 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,56,8);
HXDLIN(1296)				this->_hx___vertexBufferData = this92;
HXLINE(1298)				{
HXLINE(1298)					 ::lime::utils::ArrayBufferView this93 = this->_hx___vertexBufferData;
HXDLIN(1298)					Float val48 = ( (Float)(this->width) );
HXDLIN(1298)					 ::__hxcpp_memory_set_float(this93->buffer->b,this93->byteOffset,val48);
            				}
HXLINE(1299)				{
HXLINE(1299)					 ::lime::utils::ArrayBufferView this94 = this->_hx___vertexBufferData;
HXDLIN(1299)					Float val49 = ( (Float)(this->height) );
HXDLIN(1299)					 ::__hxcpp_memory_set_float(this94->buffer->b,(this94->byteOffset + 4),val49);
            				}
HXLINE(1300)				{
HXLINE(1300)					 ::lime::utils::ArrayBufferView this95 = this->_hx___vertexBufferData;
HXDLIN(1300)					 ::__hxcpp_memory_set_float(this95->buffer->b,(this95->byteOffset + 12),uvWidth);
            				}
HXLINE(1301)				{
HXLINE(1301)					 ::lime::utils::ArrayBufferView this96 = this->_hx___vertexBufferData;
HXDLIN(1301)					 ::__hxcpp_memory_set_float(this96->buffer->b,(this96->byteOffset + 16),uvHeight);
            				}
HXLINE(1302)				{
HXLINE(1302)					 ::lime::utils::ArrayBufferView this97 = this->_hx___vertexBufferData;
HXDLIN(1302)					Float val50 = ( (Float)(this->height) );
HXDLIN(1302)					 ::__hxcpp_memory_set_float(this97->buffer->b,(this97->byteOffset + 60),val50);
            				}
HXLINE(1303)				{
HXLINE(1303)					 ::lime::utils::ArrayBufferView this98 = this->_hx___vertexBufferData;
HXDLIN(1303)					 ::__hxcpp_memory_set_float(this98->buffer->b,(this98->byteOffset + 72),uvHeight);
            				}
HXLINE(1304)				{
HXLINE(1304)					 ::lime::utils::ArrayBufferView this99 = this->_hx___vertexBufferData;
HXDLIN(1304)					Float val51 = ( (Float)(this->width) );
HXDLIN(1304)					 ::__hxcpp_memory_set_float(this99->buffer->b,(this99->byteOffset + 112),val51);
            				}
HXLINE(1305)				{
HXLINE(1305)					 ::lime::utils::ArrayBufferView this100 = this->_hx___vertexBufferData;
HXDLIN(1305)					 ::__hxcpp_memory_set_float(this100->buffer->b,(this100->byteOffset + 124),uvWidth);
            				}
...
HXLINE(1520)			bool _hx_tmp2;
HXDLIN(1520)			if (!(textureImage->get_premultiplied())) {
HXLINE(1520)				_hx_tmp2 = textureImage->get_transparent();
            			}
            			else {
...
HXLINE(1538)		bool _hx_tmp3;
HXDLIN(1538)		if (!(this->readable)) {
HXLINE(1538)			_hx_tmp3 = hx::IsNotNull( this->image );
            		}
            		else {
HXLINE(1538)			_hx_tmp3 = false;
            		}
HXDLIN(1538)		if (_hx_tmp3) {
...
HXDLIN(1566)			::Array< int > _g11 = ::Array_obj< int >::__new(0);
HXDLIN(1566)			{
HXLINE(1566)				int _g21 = 0;
HXDLIN(1566)				while((_g21 < 256)){
HXLINE(1566)					_g21 = (_g21 + 1);
HXDLIN(1566)					int j1 = (_g21 - 1);
HXDLIN(1566)					_g11->push(0);
            				}
            			}
HXDLIN(1566)			_g->push(_g11);
HXDLIN(1566)			::Array< int > _g12 = ::Array_obj< int >::__new(0);
HXDLIN(1566)			{
HXLINE(1566)				int _g22 = 0;
HXDLIN(1566)				while((_g22 < 256)){
HXLINE(1566)					_g22 = (_g22 + 1);
HXDLIN(1566)					int j2 = (_g22 - 1);
HXDLIN(1566)					_g12->push(0);
            				}
            			}
HXDLIN(1566)			_g->push(_g12);
HXDLIN(1566)			::Array< int > _g13 = ::Array_obj< int >::__new(0);
HXDLIN(1566)			{
HXLINE(1566)				int _g23 = 0;
HXDLIN(1566)				while((_g23 < 256)){
HXLINE(1566)					_g23 = (_g23 + 1);
HXDLIN(1566)					int j3 = (_g23 - 1);
HXDLIN(1566)					_g13->push(0);
            				}
            			}
HXDLIN(1566)			_g->push(_g13);
            		}
HXDLIN(1566)		::Array< ::Dynamic> result = _g;
HXLINE(1568)		{
HXLINE(1568)			int _g14 = 0;
HXDLIN(1568)			int _g24 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(pixels);
HXDLIN(1568)			while((_g14 < _g24)){
HXLINE(1568)				_g14 = (_g14 + 1);
HXDLIN(1568)				int i = (_g14 - 1);
...
HXLINE(1582)		if (::Std_obj::is(secondObject,hx::ClassOf< ::openfl::display::Bitmap >())) {
HXLINE(1584)			secondObject = hx::TCast<  ::openfl::display::Bitmap >::cast(secondObject)->_hx___bitmapData;
            		}
HXLINE(1588)		if (::Std_obj::is(secondObject,hx::ClassOf< ::openfl::geom::Point >())) {
...
HXLINE(1605)			if (::Std_obj::is(secondObject,hx::ClassOf< ::openfl::display::BitmapData >())) {
...
HXLINE(1617)					x1 = ::Math_obj::round((secondBitmapDataPoint->x - firstPoint->x));
HXLINE(1618)					y1 = ::Math_obj::round((secondBitmapDataPoint->y - firstPoint->y));
            				}
HXLINE(1621)				 ::openfl::geom::Rectangle hitRect = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(1622)				hitRect->setTo(( (Float)(x1) ),( (Float)(y1) ),( (Float)(secondBitmapData->width) ),( (Float)(secondBitmapData->height) ));
HXLINE(1624)				if (this->rect->intersects(hitRect)) {
HXLINE(1626)					if ((x1 < 0)) {
HXLINE(1628)						hitRect->x = ( (Float)(0) );
HXLINE(1629)						hitRect->width = ::Math_obj::min(( (Float)((secondBitmapData->width + x1)) ),( (Float)(this->width) ));
            					}
            					else {
HXLINE(1633)						hitRect->width = ::Math_obj::min(( (Float)(secondBitmapData->width) ),( (Float)((this->width - x1)) ));
            					}
HXLINE(1636)					if ((y1 < 0)) {
HXLINE(1638)						hitRect->y = ( (Float)(0) );
HXLINE(1639)						hitRect->height = ::Math_obj::min(( (Float)((secondBitmapData->height + y1)) ),( (Float)(this->height) ));
            					}
            					else {
HXLINE(1643)						hitRect->height = ::Math_obj::min(( (Float)(secondBitmapData->height) ),( (Float)((this->height - y1)) ));
            					}
HXLINE(1646)					 ::openfl::utils::ByteArrayData pixels = this->getPixels(hitRect);
HXLINE(1648)					Float _hx_tmp;
HXDLIN(1648)					if ((x1 < 0)) {
HXLINE(1648)						_hx_tmp = ( (Float)(-(x1)) );
            					}
            					else {
...
HXLINE(1658)							pixel1 = pixels->readUnsignedInt();
HXLINE(1659)							testPixel = testPixels->readUnsignedInt();
HXLINE(1661)							bool _hx_tmp2;
HXDLIN(1661)							int a = (hx::UShr(pixel1,24) & 255);
HXDLIN(1661)							bool aNeg = (a < 0);
HXDLIN(1661)							bool bNeg = (firstAlphaThreshold < 0);
HXDLIN(1661)							bool _hx_tmp3;
HXDLIN(1661)							if ((aNeg != bNeg)) {
HXLINE(1661)								_hx_tmp3 = aNeg;
            							}
            							else {
HXLINE(1661)								_hx_tmp3 = (a > firstAlphaThreshold);
            							}
HXDLIN(1661)							if (_hx_tmp3) {
HXLINE(1661)								int a1 = (hx::UShr(testPixel,24) & 255);
HXDLIN(1661)								bool aNeg1 = (a1 < 0);
HXDLIN(1661)								bool bNeg1 = (secondAlphaThreshold < 0);
HXDLIN(1661)								if ((aNeg1 != bNeg1)) {
HXLINE(1661)									_hx_tmp2 = aNeg1;
            								}
            								else {
HXLINE(1661)									_hx_tmp2 = (a1 > secondAlphaThreshold);
            								}
            							}
            							else {
...
HXLINE(1671)				if (::Std_obj::is(secondObject,hx::ClassOf< ::openfl::geom::Rectangle >())) {
...
HXLINE(1678)					bool _hx_tmp4;
HXDLIN(1678)					if ((secondRectangle->width > 0)) {
HXLINE(1678)						_hx_tmp4 = (secondRectangle->height > 0);
            					}
            					else {
HXLINE(1678)						_hx_tmp4 = false;
            					}
HXDLIN(1678)					if (_hx_tmp4) {
HXLINE(1680)						 ::openfl::utils::ByteArrayData pixels1 = this->getPixels(secondRectangle);
HXLINE(1681)						int _hx_int = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(pixels1);
HXDLIN(1681)						Float length1;
HXDLIN(1681)						if ((_hx_int < 0)) {
HXLINE(1681)							length1 = (((Float)4294967296.0) + _hx_int);
            						}
            						else {
HXLINE(1681)							length1 = (_hx_int + ((Float)0.0));
            						}
HXDLIN(1681)						int int1 = 4;
HXDLIN(1681)						Float length2;
HXDLIN(1681)						if ((int1 < 0)) {
HXLINE(1681)							length2 = (((Float)4294967296.0) + int1);
            						}
            						else {
HXLINE(1681)							length2 = (int1 + ((Float)0.0));
            						}
HXDLIN(1681)						int length3 = ::Std_obj::_hx_int((length1 / length2));
HXLINE(1682)						int pixel2;
HXLINE(1684)						{
HXLINE(1684)							int _g2 = 0;
HXDLIN(1684)							int _g11 = length3;
HXDLIN(1684)							while((_g2 < _g11)){
HXLINE(1684)								_g2 = (_g2 + 1);
HXDLIN(1684)								int i1 = (_g2 - 1);
HXLINE(1686)								pixel2 = pixels1->readUnsignedInt();
HXLINE(1688)								int a2 = (hx::UShr(pixel2,24) & 255);
HXDLIN(1688)								bool aNeg2 = (a2 < 0);
HXDLIN(1688)								bool bNeg2 = (firstAlphaThreshold < 0);
HXDLIN(1688)								bool _hx_tmp5;
HXDLIN(1688)								if ((aNeg2 != bNeg2)) {
HXLINE(1688)									_hx_tmp5 = aNeg2;
            								}
            								else {
HXLINE(1688)									_hx_tmp5 = (a2 > firstAlphaThreshold);
            								}
HXDLIN(1688)								if (_hx_tmp5) {
...
HXLINE(1782)				{
HXLINE(1782)					int _g2 = 0;
HXDLIN(1782)					int _g11 = this->width;
HXDLIN(1782)					while((_g2 < _g11)){
HXLINE(1782)						_g2 = (_g2 + 1);
HXDLIN(1782)						int x = (_g2 - 1);
...
HXLINE(1882)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("End of file was encountered.",d3,7b,d9,4f),2030));
            		}
...
HXLINE(2040)			Float _hx_tmp4;
HXDLIN(2040)			if (this->transparent) {
HXLINE(2040)				_hx_tmp4 = (( (Float)((hx::UShr(color1,24) & 255)) ) / ( (Float)(255) ));
            			}
            			else {
HXLINE(2040)				_hx_tmp4 = ( (Float)(1) );
            			}
HXDLIN(2040)			context->clear((( (Float)((hx::UShr(color1,16) & 255)) ) / ( (Float)(255) )),(( (Float)((hx::UShr(color1,8) & 255)) ) / ( (Float)(255) )),(( (Float)((color1 & 255)) ) / ( (Float)(255) )),_hx_tmp4,0,0,1);
...
HXLINE(2058)				 ::lime::graphics::Image _hx_tmp5 = this->image;
HXDLIN(2058)				_hx_tmp5->fillRect(rect->_hx___toLimeRectangle(),color,1);
            			}
            		}
            	}
