...
HXLINE( 222)					_hx_tmp2 = !(this->isError);
            				}
            				else {
HXLINE( 222)					_hx_tmp2 = false;
            				}
HXDLIN( 222)				if (_hx_tmp2) {
HXLINE( 222)					_hx_tmp1 = (time <= end);
            				}
            				else {
...
HXLINE( 281)					 ::lime::app::Future future1 = ( ( ::lime::app::Future)(next(val)) );
HXLINE( 282)					future1->onError(promise->error_dyn());
HXLINE( 283)					future1->onComplete(promise->complete_dyn());
            				}
